...
const DAY_RECIPE_ART_IMAGES = Object.freeze({
  petit_dejeuner_maitre: '/assets/day/category-petit-dejeuner-day.jpg?v=288',
  apero_maitre: '/assets/day/category-apero-day.jpg?v=288',
  entrees_maitre: '/assets/day/category-entrees-day.jpg?v=288',
  sauces_maitre: '/assets/day/category-sauces-day.jpg?v=288',
  elements_base_maitre: '/assets/day/category-bases-day.jpg?v=288',
  plats_maitre: '/assets/day/category-plats-day.jpg?v=288',
  accompagnements_maitre: '/assets/day/category-accompagnements-day.jpg?v=288',
  desserts_maitre: '/assets/day/category-desserts-day.jpg?v=288',
  bouillabaisse_rouille: '/assets/day/recipe-seafood-day.jpg?v=288',
  brioche_perdue_caramel_beurre_sale: '/assets/day/recipe-brioche_perdue_caramel_beurre_sale-day.jpg?v=288',
  chocolat_ancien: '/assets/day/recipe-chocolat_ancien-day.jpg?v=288',
  crepes_lait_amandes: '/assets/day/recipe-crepes_lait_amandes-day.jpg?v=288',
  gaufre_bruxelles: '/assets/day/recipe-gaufre_bruxelles-day.jpg?v=288',
  oeuf_chili_crisp_toast: '/assets/day/recipe-oeuf_chili_crisp_toast-day.jpg?v=288',
  pancakes_variantes: '/assets/day/recipe-pancakes_variantes-day.jpg?v=288',
  pancakes_fluffy: '/assets/day/recipe-pancakes_fluffy-day.jpg?v=288',
  aioli_citronne_leger: '/assets/day/recipe-aioli_citronne_leger-day.jpg?v=288',
  beignets_calamar: '/assets/day/recipe-beignets_calamar-day.jpg?v=288',
  beurre_ail: '/assets/day/recipe-beurre_ail-day.jpg?v=288',
  billes_mozzarella_marinees: '/assets/day/recipe-billes_mozzarella_marinees-day.jpg?v=288',
  brie_farci_fruits_secs_noix: '/assets/day/recipe-brie_farci_fruits_secs_noix-day.jpg?v=288',
  brochettes_crevettes_chorizo: '/assets/day/recipe-brochettes_crevettes_chorizo-day.jpg?v=288',
  brochettes_melon_epice: '/assets/day/recipe-brochettes_melon_epice-day.jpg?v=288',
  bruschetta_roquefort_noix: '/assets/day/recipe-bruschetta_roquefort_noix-day.jpg?v=288',
  cake_sale_lardon: '/assets/day/recipe-cake_sale_lardon-day.jpg?v=288',
  cake_tomate_chorizo_feta: '/assets/day/recipe-cake_tomate_chorizo_feta-day.jpg?v=288',
  chorizo_au_cidre: '/assets/day/recipe-chorizo_au_cidre-day.jpg?v=288',
  chou_fleur_croustillant: '/assets/day/recipe-chou_fleur_croustillant-day.jpg?v=288',
  cookies_sales_variantes: '/assets/day/recipe-cookies_sales_variantes-day.jpg?v=288',
  croquettes_pommes_de_terre: '/assets/day/recipe-croquettes_pommes_de_terre-day.jpg?v=288',
  falafels_four: '/assets/day/recipe-falafels_four-day.jpg?v=288',
  gressins_fromage_olives: '/assets/day/recipe-gressins_fromage_olives-day.jpg?v=288',
  houmous_hakocem: '/assets/day/recipe-houmous_hakocem-day.jpg?v=288',
  madeleines_comte_epices_douces: '/assets/day/recipe-madeleines_comte_epices_douces-day.jpg?v=288',
  mojitos_variantes: '/assets/day/recipe-mojitos_variantes-day.jpg?v=288',
  oeufs_cocotte_chorizo: '/assets/day/recipe-oeufs_cocotte_chorizo-day.jpg?v=288',
  oeufs_mimosa_variantes: '/assets/day/recipe-oeufs_mimosa_variantes-day.jpg?v=288',
  pain_grille_beurre_ail_herbes: '/assets/day/recipe-pain_grille_beurre_ail_herbes-day.jpg?v=288',
  pate_lapin_piment_espelette: '/assets/day/recipe-pate_lapin_piment_espelette-day.jpg?v=288',
  pesto_tomates_sechees_sans_cajou: '/assets/day/recipe-pesto_tomates_sechees_sans_cajou-day.jpg?v=288',
  rillettes_porc: '/assets/day/recipe-rillettes_porc-day.jpg?v=288',
  rillettes_poulet: '/assets/day/recipe-rillettes_poulet-day.jpg?v=288',
  samoussas_boeuf_epinards_petits_pois: '/assets/day/recipe-samoussas_boeuf_epinards_petits_pois-day.jpg?v=288',
  sauce_yaourt_citronnee: '/assets/day/recipe-sauce_yaourt_citronnee-day.jpg?v=288',
  tempura_beignets_calamar_crevettes: '/assets/day/recipe-tempura_beignets_calamar_crevettes-day.jpg?v=288',
  terrine_campagne: '/assets/day/recipe-terrine_campagne-day.jpg?v=288',
  terrine_porc_pistaches: '/assets/day/recipe-terrine_porc_pistaches-day.jpg?v=288',
  tomates_cocktail_thon_mascarpone: '/assets/day/recipe-tomates_cocktail_thon_mascarpone-day.jpg?v=288',
  tomates_variantes: '/assets/day/recipe-tomates_variantes-day.jpg?v=288',
  verrines_chataignes_foie_gras: '/assets/day/recipe-verrines_chataignes_foie_gras-day.jpg?v=288',
  ajitsuke_tamago_oeufs_marines_ramen: '/assets/day/recipe-ajitsuke_tamago_oeufs_marines_ramen-day.jpg?v=288',
  asperges_mimosa: '/assets/day/recipe-asperges_mimosa-day.jpg?v=288',
  bricks_fromage_miel_poires_pecan: '/assets/day/recipe-bricks_fromage_miel_poires_pecan-day.jpg?v=288',
  carpaccio_betterave_mozzarella_yuzu: '/assets/day/recipe-carpaccio_betterave_mozzarella_yuzu-day.jpg?v=288',
  cassolette_crevettes_ravioles_persil: '/assets/day/recipe-cassolette_crevettes_ravioles_persil-day.jpg?v=288',
  chipirons_a_la_plancha: '/assets/day/recipe-chipirons_a_la_plancha-day.jpg?v=288',
  crudites_maitre: '/assets/day/recipe-crudites_maitre-day.jpg?v=288',
  legumes_rotis: '/assets/day/recipe-legumes_rotis-day.jpg?v=288',
  oeufs_meurette_faciles: '/assets/day/recipe-oeufs_meurette_faciles-day.jpg?v=288',
  oignons_rotis_thym_miel: '/assets/day/recipe-oignons_rotis_thym_miel-day.jpg?v=288',
  salade_epinards_clementines_amande_feta: '/assets/day/recipe-salade_epinards_clementines_amande_feta-day.jpg?v=288',
  salade_pois_chiche_feta_olives: '/assets/day/recipe-salade_pois_chiche_feta_olives-day.jpg?v=288',
  salade_pois_chiches_thon_poivrons: '/assets/day/recipe-salade_pois_chiches_thon_poivrons-day.jpg?v=288',
  salade_caprese: '/assets/day/recipe-salade_caprese-day.jpg?v=288',
  tomates_maitre: '/assets/day/recipe-tomates_maitre-day.jpg?v=288',
  veloute_hiver_noix_cajou: '/assets/day/recipe-veloute_hiver_noix_cajou-day.jpg?v=288',
  beurre_d_escargot_persille: '/assets/day/recipe-beurre_d_escargot_persille-day.jpg?v=288',
  coulis_maitre: '/assets/day/recipe-coulis_maitre-day.jpg?v=288',
  sauce_chevre_creme: '/assets/day/recipe-sauce_chevre_creme-day.jpg?v=288',
  sauce_mornay: '/assets/day/recipe-sauce_mornay-day.jpg?v=288',
  sauce_roquefort: '/assets/day/recipe-sauce_roquefort-day.jpg?v=288',
  sauces_burger_variantes: '/assets/day/recipe-sauces_burger_variantes-day.jpg?v=288',
  sauces_assaisonnements_maitre: '/assets/day/recipe-sauces_assaisonnements_maitre-day.jpg?v=288',
  toppings_frites: '/assets/day/recipe-toppings_frites-day.jpg?v=288'
});
const SITE_VERSION = 'v2.88';
const SITE_UPDATED_AT = '03/07/26';
...
const ANDROID_LEGACY_APK_VERSION = '2.88';
...
const EMPTY_MENU = { items: [], reason: '', quality: NaN };
const EMPTY_MENU_SERVICE_PLAN = {
  timeline: [],
...
function MenuPlannerPanel({ open, onClose, recipes, openRecipe, addMenuToShopping, notify }) {
  ...
  const menu = useMemo(() => open ? buildMenuSuggestionWithOverrides(recipes, offset, themeId, menuHistory, itemOffsets) : EMPTY_MENU, [open, recipes, offset, themeId, menuHistory, itemOffsets]);
  const menuItems = useMemo(() => menu.items || [], [menu]);
  const menuRecipes = useMemo(() => menuItems.map(item => item.recipe), [menuItems]);
  const menuFactorById = useMemo(() => open ? menuFactorMapFor(menuRecipes, peopleCount) : {}, [open, menuRecipes, peopleCount]);
