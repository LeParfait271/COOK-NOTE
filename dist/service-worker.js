// ============================================================
//  Cook Note - Service Worker PWA v251
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v251';
const IMAGE_CACHE_NAME = 'cook-note-images-v251';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=251',
  '/app-images.js?v=251',
  '/assets/catalog-1.js?v=251',
  '/assets/image-manifest.js?v=251',
  '/style.css?v=251',
  '/recipe.js?v=251',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v251] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v251] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
