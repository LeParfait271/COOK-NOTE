// ============================================================
//  Cook Note - Service Worker PWA v210
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v210';
const IMAGE_CACHE_NAME = 'cook-note-images-v210';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=210',
  '/app-images.js?v=210',
  '/assets/catalog-1.js?v=210',
  '/assets/image-manifest.js?v=210',
  '/style.css?v=210',
  '/recipe.js?v=210',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v210] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v210] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
