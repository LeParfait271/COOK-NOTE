// ============================================================
//  Cook Note - Service Worker PWA v198
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v198';
const IMAGE_CACHE_NAME = 'cook-note-images-v198';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=198',
  '/app-images.js?v=198',
  '/assets/catalog-1.js?v=198',
  '/assets/image-manifest.js?v=198',
  '/style.css?v=198',
  '/recipe.js?v=198',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v198] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v198] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
