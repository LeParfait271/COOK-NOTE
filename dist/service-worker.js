// ============================================================
//  Cook Note - Service Worker PWA v215
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v215';
const IMAGE_CACHE_NAME = 'cook-note-images-v215';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=215',
  '/app-images.js?v=215',
  '/assets/catalog-1.js?v=215',
  '/assets/image-manifest.js?v=215',
  '/style.css?v=215',
  '/recipe.js?v=215',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v215] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v215] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
