// ============================================================
//  Cook Note - Service Worker PWA v326
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v326';
const IMAGE_CACHE_NAME = 'cook-note-images-v326';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=326-parent-title',
  '/app-images.js?v=326-parent-title',
  '/app-art-images.js?v=326-parent-title',
  '/theme.js?v=326-parent-title',
  '/i18n.js?v=326-parent-title',
  '/assets/catalog-1.js?v=326-parent-title',
  '/assets/image-manifest.js?v=326-parent-title',
  '/style.css?v=326-parent-title',
  '/recipe.js?v=326-parent-title',
  '/manifest.json',
