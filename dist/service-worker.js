// ============================================================
//  Cook Note - Service Worker PWA v197
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v197';
const IMAGE_CACHE_NAME = 'cook-note-images-v197';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=197',
  '/app-images.js?v=197',
  '/assets/catalog-1.js?v=197',
  '/assets/image-manifest.js?v=197',
  '/style.css?v=197',
  '/recipe.js?v=197',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v197] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v197] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
