// ============================================================
//  Cook Note - Service Worker PWA v447
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v447';
const IMAGE_CACHE_NAME = 'cook-note-images-v447';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=447-parent-title',
  '/app-techniques.js?v=447-parent-title',
  '/app-premium.js?v=447-parent-title',
  '/app-images.js?v=447-parent-title',
  '/app-art-images.js?v=447-parent-title',
  '/app-inline-variant-rules.js?v=447-parent-title',
  '/theme.js?v=447-parent-title',
  '/i18n.js?v=447-parent-title',
  '/assets/catalog-1.js?v=447-parent-title',
  '/assets/image-manifest.js?v=447-parent-title',
  '/style.css?v=447-parent-title',
  '/manifest.json',
