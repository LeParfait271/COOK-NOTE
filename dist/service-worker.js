// ============================================================
//  Cook Note - Service Worker PWA v436
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v436';
const IMAGE_CACHE_NAME = 'cook-note-images-v436';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=436-parent-title',
  '/app-techniques.js?v=436-parent-title',
  '/app-premium.js?v=436-parent-title',
  '/app-images.js?v=436-parent-title',
  '/app-art-images.js?v=436-parent-title',
  '/theme.js?v=436-parent-title',
  '/i18n.js?v=436-parent-title',
  '/assets/catalog-1.js?v=436-parent-title',
  '/assets/image-manifest.js?v=436-parent-title',
  '/style.css?v=436-parent-title',
  '/manifest.json',
