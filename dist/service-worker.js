// ============================================================
//  Cook Note - Service Worker PWA v250
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v250';
const IMAGE_CACHE_NAME = 'cook-note-images-v250';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=250',
  '/app-images.js?v=250',
  '/assets/catalog-1.js?v=250',
  '/assets/image-manifest.js?v=250',
  '/style.css?v=250',
  '/recipe.js?v=250',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v250] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v250] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
