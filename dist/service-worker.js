// ============================================================
//  Cook Note - Service Worker PWA v246
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v246';
const IMAGE_CACHE_NAME = 'cook-note-images-v246';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=246',
  '/app-images.js?v=246',
  '/assets/catalog-1.js?v=246',
  '/assets/image-manifest.js?v=246',
  '/style.css?v=246',
  '/recipe.js?v=246',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v246] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v246] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
