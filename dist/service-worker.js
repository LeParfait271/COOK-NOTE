// ============================================================
//  Cook Note - Service Worker PWA v265
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v265';
const IMAGE_CACHE_NAME = 'cook-note-images-v265';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=265',
  '/app-images.js?v=265',
  '/assets/catalog-1.js?v=265',
  '/assets/image-manifest.js?v=265',
  '/style.css?v=265',
  '/recipe.js?v=265',
  '/manifest.json',
