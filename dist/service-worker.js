// ============================================================
//  Cook Note - Service Worker PWA v319
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v319';
const IMAGE_CACHE_NAME = 'cook-note-images-v319';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=319',
  '/app-images.js?v=319',
  '/app-art-images.js?v=319',
  '/theme.js?v=319',
  '/i18n.js?v=319',
  '/assets/catalog-1.js?v=319',
  '/assets/image-manifest.js?v=319',
  '/style.css?v=319',
  '/recipe.js?v=319',
  '/manifest.json',
  ...
  '/assets/cook-note-white.png',
  '/assets/base-principale-fond-site.jpg',
  '/assets/day/base-du-site-day.jpg?v=319',
  '/assets/day/base-principale-fond-site-day.jpg?v=319',
  '/assets/day/category-apero-day.jpg?v=319',
  '/assets/day/category-accompagnements-day.jpg?v=319',
  '/assets/day/category-bases-day.jpg?v=319',
  '/assets/day/category-desserts-day.jpg?v=319',
  '/assets/day/category-entrees-day.jpg?v=319',
  '/assets/day/category-petit-dejeuner-day.jpg?v=319',
  '/assets/day/category-plats-day.jpg?v=319',
  '/assets/day/category-sauces-day.jpg?v=319',
  '/assets/day/cook-note-day.png?v=319',
  '/assets/day/recipe-seafood-day.jpg?v=319',
  '/assets/dark/recipe-beurre_ail-dark.jpg?v=319',
];
