// ============================================================
//  Cook Note - Service Worker PWA v463
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v463';
const IMAGE_CACHE_NAME = 'cook-note-images-v463';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=463-parent-title',
  '/app-cooking.js?v=463-parent-title',
  '/app-techniques.js?v=463-parent-title',
  '/app-premium.js?v=463-parent-title',
  '/app-images.js?v=463-parent-title',
  '/app-art-images.js?v=463-parent-title',
  '/app-inline-variant-rules.js?v=463-parent-title',
  '/theme.js?v=463-parent-title',
  '/i18n.js?v=463-parent-title',
  '/assets/catalog-1.js?v=463-parent-title',
  '/assets/image-manifest.js?v=463-parent-title',
  '/style.css?v=463-parent-title',
  '/manifest.json',
