// ============================================================
//  Cook Note - Service Worker PWA v325
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v325';
const IMAGE_CACHE_NAME = 'cook-note-images-v325';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=325-parent-title',
  '/app-images.js?v=325-parent-title',
  '/app-art-images.js?v=325-parent-title',
  '/theme.js?v=325-parent-title',
  '/i18n.js?v=325-parent-title',
  '/assets/catalog-1.js?v=325-parent-title',
  '/assets/image-manifest.js?v=325-parent-title',
  '/style.css?v=325-parent-title',
  '/recipe.js?v=325-parent-title',
  '/manifest.json',
