// ============================================================
//  Cook Note - Service Worker PWA v1100
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v1100';
const IMAGE_CACHE_NAME = 'cook-note-images-v1100';
...
const STATIC_ASSETS = [
  ...
  '/recipe.html',
  '/app.js?v=1100',
  '/app-images.js?v=1100',
  '/assets/catalog-1.js?v=1100',
  '/assets/image-manifest.js?v=1100',
  '/style.css?v=1100',
  '/recipe.js?v=1100',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v1100] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v1100] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
