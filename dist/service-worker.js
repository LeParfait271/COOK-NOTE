// ============================================================
//  Cook Note - Service Worker PWA v530
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v530';
const IMAGE_CACHE_NAME = 'cook-note-images-v530';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=530-parent-title',
  '/app-techniques.js?v=530-parent-title',
  '/app-premium.js?v=530-parent-title',
  '/app-personal-tools.js?v=528',
  '/app-safety-sources.js?v=528',
  '/app-images.js?v=530-parent-title',
  '/app-art-images.js?v=530-parent-title',
  '/app-inline-variant-rules.js?v=530-parent-title',
  '/theme.js?v=530-parent-title',
  '/i18n.js?v=530-parent-title',
  '/assets/catalog-1.js?v=530-parent-title',
  '/recipe-worker.js',
  '/assets/image-manifest.js?v=530-parent-title',
  '/style.css?v=530-parent-title',
  '/recipe-editorial.css?v=530-parent-title',
