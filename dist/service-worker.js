// ============================================================
//  Cook Note - Service Worker PWA v217
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v217';
const IMAGE_CACHE_NAME = 'cook-note-images-v217';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=217',
  '/app-images.js?v=217',
  '/assets/catalog-1.js?v=217',
  '/assets/image-manifest.js?v=217',
  '/style.css?v=217',
  '/recipe.js?v=217',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v217] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v217] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
