// ============================================================
//  Cook Note - Service Worker PWA v449
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v449';
const IMAGE_CACHE_NAME = 'cook-note-images-v449';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=449-parent-title',
  '/app-techniques.js?v=449-parent-title',
  '/app-premium.js?v=449-parent-title',
  '/app-images.js?v=449-parent-title',
  '/app-art-images.js?v=449-parent-title',
  '/app-inline-variant-rules.js?v=449-parent-title',
  '/theme.js?v=449-parent-title',
  '/i18n.js?v=449-parent-title',
  '/assets/catalog-1.js?v=449-parent-title',
  '/assets/image-manifest.js?v=449-parent-title',
  '/style.css?v=449-parent-title',
  '/manifest.json',
