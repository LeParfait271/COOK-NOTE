// ============================================================
//  Cook Note - Service Worker PWA v193
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v193';
const IMAGE_CACHE_NAME = 'cook-note-images-v193';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=193',
  '/app-images.js?v=193',
  '/assets/catalog-1.js?v=193',
  '/assets/image-manifest.js?v=193',
  '/style.css?v=193',
  '/recipe.js?v=193',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v193] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v193] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
