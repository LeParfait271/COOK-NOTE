// ============================================================
//  Cook Note - Service Worker PWA v206
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v206';
const IMAGE_CACHE_NAME = 'cook-note-images-v206';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=206',
  '/app-images.js?v=206',
  '/assets/catalog-1.js?v=206',
  '/assets/image-manifest.js?v=206',
  '/style.css?v=206',
  '/recipe.js?v=206',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v206] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v206] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
