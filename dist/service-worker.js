// ============================================================
//  Cook Note - Service Worker PWA v207
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v207';
const IMAGE_CACHE_NAME = 'cook-note-images-v207';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=207',
  '/app-images.js?v=207',
  '/assets/catalog-1.js?v=207',
  '/assets/image-manifest.js?v=207',
  '/style.css?v=207',
  '/recipe.js?v=207',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v207] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v207] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
