// ============================================================
//  Cook Note - Service Worker PWA v209
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v209';
const IMAGE_CACHE_NAME = 'cook-note-images-v209';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=209',
  '/app-images.js?v=209',
  '/assets/catalog-1.js?v=209',
  '/assets/image-manifest.js?v=209',
  '/style.css?v=209',
  '/recipe.js?v=209',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v209] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v209] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
