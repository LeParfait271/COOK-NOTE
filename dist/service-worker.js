// ============================================================
//  Cook Note - Service Worker PWA v364
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v364';
const IMAGE_CACHE_NAME = 'cook-note-images-v364';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=364-parent-title',
  '/app-techniques.js?v=364-parent-title',
  '/app-premium.js?v=364-parent-title',
  '/app-images.js?v=364-parent-title',
  '/app-art-images.js?v=364-parent-title',
  '/theme.js?v=364-parent-title',
  '/i18n.js?v=364-parent-title',
  '/assets/catalog-1.js?v=364-parent-title',
  '/assets/image-manifest.js?v=364-parent-title',
  '/style.css?v=364-parent-title',
  '/recipe.js?v=364-parent-title',
  '/manifest.json',
