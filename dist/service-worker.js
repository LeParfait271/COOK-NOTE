// ============================================================
//  Cook Note - Service Worker PWA v238
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v238';
const IMAGE_CACHE_NAME = 'cook-note-images-v238';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=238',
  '/app-images.js?v=238',
  '/assets/catalog-1.js?v=238',
  '/assets/image-manifest.js?v=238',
  '/style.css?v=238',
  '/recipe.js?v=238',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v238] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v238] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
