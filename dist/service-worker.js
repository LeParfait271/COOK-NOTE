// ============================================================
//  Cook Note - Service Worker PWA v228
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v228';
const IMAGE_CACHE_NAME = 'cook-note-images-v228';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=228',
  '/app-images.js?v=228',
  '/assets/catalog-1.js?v=228',
  '/assets/image-manifest.js?v=228',
  '/style.css?v=228',
  '/recipe.js?v=228',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v228] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v228] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
