// ============================================================
//  Cook Note - Service Worker PWA v229
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v229';
const IMAGE_CACHE_NAME = 'cook-note-images-v229';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=229',
  '/app-images.js?v=229',
  '/assets/catalog-1.js?v=229',
  '/assets/image-manifest.js?v=229',
  '/style.css?v=229',
  '/recipe.js?v=229',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v229] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v229] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
