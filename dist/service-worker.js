// ============================================================
//  Cook Note - Service Worker PWA v199
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v199';
const IMAGE_CACHE_NAME = 'cook-note-images-v199';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=199',
  '/app-images.js?v=199',
  '/assets/catalog-1.js?v=199',
  '/assets/image-manifest.js?v=199',
  '/style.css?v=199',
  '/recipe.js?v=199',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v199] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v199] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
