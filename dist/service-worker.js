// ============================================================
//  Cook Note - Service Worker PWA v220
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v220';
const IMAGE_CACHE_NAME = 'cook-note-images-v220';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=220',
  '/app-images.js?v=220',
  '/assets/catalog-1.js?v=220',
  '/assets/image-manifest.js?v=220',
  '/style.css?v=220',
  '/recipe.js?v=220',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v220] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v220] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
