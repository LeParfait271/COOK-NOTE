// ============================================================
//  Cook Note - Service Worker PWA v226
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v226';
const IMAGE_CACHE_NAME = 'cook-note-images-v226';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=226',
  '/app-images.js?v=226',
  '/assets/catalog-1.js?v=226',
  '/assets/image-manifest.js?v=226',
  '/style.css?v=226',
  '/recipe.js?v=226',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v226] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v226] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
