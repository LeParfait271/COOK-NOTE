// ============================================================
//  Cook Note - Service Worker PWA v174
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v174';
const IMAGE_CACHE_NAME = 'cook-note-images-v174';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=174',
  '/app-images.js?v=174',
  '/assets/catalog-1.js?v=174',
  '/assets/image-manifest.js?v=174',
  '/style.css?v=174',
  '/recipe.js?v=174',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v174] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v174] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
