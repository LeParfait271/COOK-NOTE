// ============================================================
//  Cook Note - Service Worker PWA v212
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v212';
const IMAGE_CACHE_NAME = 'cook-note-images-v212';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=212',
  '/app-images.js?v=212',
  '/assets/catalog-1.js?v=212',
  '/assets/image-manifest.js?v=212',
  '/style.css?v=212',
  '/recipe.js?v=212',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v212] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v212] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
