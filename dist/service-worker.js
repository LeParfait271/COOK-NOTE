// ============================================================
//  Cook Note - Service Worker PWA v213
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v213';
const IMAGE_CACHE_NAME = 'cook-note-images-v213';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=213',
  '/app-images.js?v=213',
  '/assets/catalog-1.js?v=213',
  '/assets/image-manifest.js?v=213',
  '/style.css?v=213',
  '/recipe.js?v=213',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v213] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v213] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
