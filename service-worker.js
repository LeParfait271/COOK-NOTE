// ============================================================
//  Cook Note - Service Worker PWA v227
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v227';
const IMAGE_CACHE_NAME = 'cook-note-images-v227';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=227',
  '/app-images.js?v=227',
  '/assets/catalog-1.js?v=227',
  '/assets/image-manifest.js?v=227',
  '/style.css?v=227',
  '/recipe.js?v=227',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v227] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v227] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
