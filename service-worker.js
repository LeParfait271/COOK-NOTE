// ============================================================
//  Cook Note - Service Worker PWA v211
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v211';
const IMAGE_CACHE_NAME = 'cook-note-images-v211';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=211',
  '/app-images.js?v=211',
  '/assets/catalog-1.js?v=211',
  '/assets/image-manifest.js?v=211',
  '/style.css?v=211',
  '/recipe.js?v=211',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v211] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v211] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
