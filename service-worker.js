// ============================================================
//  Cook Note - Service Worker PWA v179
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v179';
const IMAGE_CACHE_NAME = 'cook-note-images-v179';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=179',
  '/app-images.js?v=179',
  '/assets/catalog-1.js?v=179',
  '/assets/image-manifest.js?v=179',
  '/style.css?v=179',
  '/recipe.js?v=179',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v179] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v179] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
