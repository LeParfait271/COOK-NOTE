// ============================================================
//  Cook Note - Service Worker PWA v245
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v245';
const IMAGE_CACHE_NAME = 'cook-note-images-v245';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=245',
  '/app-images.js?v=245',
  '/assets/catalog-1.js?v=245',
  '/assets/image-manifest.js?v=245',
  '/style.css?v=245',
  '/recipe.js?v=245',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v245] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v245] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
