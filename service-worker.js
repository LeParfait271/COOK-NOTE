// ============================================================
//  Cook Note - Service Worker PWA v188
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v188';
const IMAGE_CACHE_NAME = 'cook-note-images-v188';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=188',
  '/app-images.js?v=188',
  '/assets/catalog-1.js?v=188',
  '/assets/image-manifest.js?v=188',
  '/style.css?v=188',
  '/recipe.js?v=188',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v188] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v188] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
