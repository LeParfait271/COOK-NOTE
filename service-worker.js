// ============================================================
//  Cook Note - Service Worker PWA v200
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v200';
const IMAGE_CACHE_NAME = 'cook-note-images-v200';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=200',
  '/app-images.js?v=200',
  '/assets/catalog-1.js?v=200',
  '/assets/image-manifest.js?v=200',
  '/style.css?v=200',
  '/recipe.js?v=200',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v200] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v200] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
