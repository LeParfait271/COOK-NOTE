// ============================================================
//  Cook Note - Service Worker PWA v208
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v208';
const IMAGE_CACHE_NAME = 'cook-note-images-v208';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=208',
  '/app-images.js?v=208',
  '/assets/catalog-1.js?v=208',
  '/assets/image-manifest.js?v=208',
  '/style.css?v=208',
  '/recipe.js?v=208',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v208] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v208] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
