// ============================================================
//  Cook Note - Service Worker PWA v249
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v249';
const IMAGE_CACHE_NAME = 'cook-note-images-v249';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=249',
  '/app-images.js?v=249',
  '/assets/catalog-1.js?v=249',
  '/assets/image-manifest.js?v=249',
  '/style.css?v=249',
  '/recipe.js?v=249',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v249] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v249] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
