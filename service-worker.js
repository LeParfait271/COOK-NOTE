// ============================================================
//  Cook Note - Service Worker PWA v181
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v181';
const IMAGE_CACHE_NAME = 'cook-note-images-v181';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=181',
  '/app-images.js?v=181',
  '/assets/catalog-1.js?v=181',
  '/assets/image-manifest.js?v=181',
  '/style.css?v=181',
  '/recipe.js?v=181',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v181] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v181] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
