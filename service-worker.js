// ============================================================
//  Cook Note - Service Worker PWA v252
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v252';
const IMAGE_CACHE_NAME = 'cook-note-images-v252';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=252',
  '/app-images.js?v=252',
  '/assets/catalog-1.js?v=252',
  '/assets/image-manifest.js?v=252',
  '/style.css?v=252',
  '/recipe.js?v=252',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v252] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v252] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
