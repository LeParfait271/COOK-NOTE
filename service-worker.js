// ============================================================
//  Cook Note - Service Worker PWA v216
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v216';
const IMAGE_CACHE_NAME = 'cook-note-images-v216';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=216',
  '/app-images.js?v=216',
  '/assets/catalog-1.js?v=216',
  '/assets/image-manifest.js?v=216',
  '/style.css?v=216',
  '/recipe.js?v=216',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v216] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v216] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
