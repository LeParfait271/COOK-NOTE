// ============================================================
//  Cook Note - Service Worker PWA v224
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v224';
const IMAGE_CACHE_NAME = 'cook-note-images-v224';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=224',
  '/app-images.js?v=224',
  '/assets/catalog-1.js?v=224',
  '/assets/image-manifest.js?v=224',
  '/style.css?v=224',
  '/recipe.js?v=224',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v224] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v224] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
