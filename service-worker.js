// ============================================================
//  Cook Note - Service Worker PWA v324
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v324';
const IMAGE_CACHE_NAME = 'cook-note-images-v324';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=324-parent-title',
  '/app-images.js?v=324-parent-title',
  '/app-art-images.js?v=324-parent-title',
  '/theme.js?v=324-parent-title',
  '/i18n.js?v=324-parent-title',
  '/assets/catalog-1.js?v=324-parent-title',
  '/assets/image-manifest.js?v=324-parent-title',
  '/style.css?v=324-parent-title',
  '/recipe.js?v=324-parent-title',
  '/manifest.json',
