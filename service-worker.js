// ============================================================
//  Cook Note - Service Worker PWA v344
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v344';
const IMAGE_CACHE_NAME = 'cook-note-images-v344';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=344-parent-title',
  '/app-techniques.js?v=344-parent-title',
  '/app-premium.js?v=344-parent-title',
  '/app-images.js?v=344-parent-title',
  '/app-art-images.js?v=344-parent-title',
  '/theme.js?v=344-parent-title',
  '/i18n.js?v=344-parent-title',
  '/assets/catalog-1.js?v=344-parent-title',
  '/assets/image-manifest.js?v=344-parent-title',
  '/style.css?v=344-parent-title',
  '/recipe.js?v=344-parent-title',
  '/manifest.json',
