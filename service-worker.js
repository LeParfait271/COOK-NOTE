// ============================================================
//  Cook Note - Service Worker PWA v214
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v214';
const IMAGE_CACHE_NAME = 'cook-note-images-v214';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=214',
  '/app-images.js?v=214',
  '/assets/catalog-1.js?v=214',
  '/assets/image-manifest.js?v=214',
  '/style.css?v=214',
  '/recipe.js?v=214',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v214] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v214] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
