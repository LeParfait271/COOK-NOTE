...
const STATIC_ASSETS = [
  ...
  '/app.js?v=167',
  '/app-images.js?v=167',
  '/assets/catalog-1.js?v=167',
  '/assets/catalog-2.js?v=167',
  '/assets/catalog-3.js?v=167',
  '/assets/catalog-4.js?v=167',
  '/assets/image-manifest.js?v=167',
  '/style.css?v=167',
  '/recipe.js?v=167',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v167] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v167] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
