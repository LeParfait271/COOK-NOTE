// ============================================================
//  Cook Note - Service Worker PWA v233
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v233';
const IMAGE_CACHE_NAME = 'cook-note-images-v233';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=233',
  '/app-images.js?v=233',
  '/assets/catalog-1.js?v=233',
  '/assets/image-manifest.js?v=233',
  '/style.css?v=233',
  '/recipe.js?v=233',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v233] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v233] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
