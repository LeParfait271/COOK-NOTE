// ============================================================
//  Cook Note - Service Worker PWA v221
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v221';
const IMAGE_CACHE_NAME = 'cook-note-images-v221';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=221',
  '/app-images.js?v=221',
  '/assets/catalog-1.js?v=221',
  '/assets/image-manifest.js?v=221',
  '/style.css?v=221',
  '/recipe.js?v=221',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v221] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v221] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
