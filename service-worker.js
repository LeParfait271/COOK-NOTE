// ============================================================
//  Cook Note - Service Worker PWA v175
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v175';
const IMAGE_CACHE_NAME = 'cook-note-images-v175';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=175',
  '/app-images.js?v=175',
  '/assets/catalog-1.js?v=175',
  '/assets/image-manifest.js?v=175',
  '/style.css?v=175',
  '/recipe.js?v=175',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v175] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v175] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
