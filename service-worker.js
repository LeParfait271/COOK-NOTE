// ============================================================
//  Cook Note - Service Worker PWA v191
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v191';
const IMAGE_CACHE_NAME = 'cook-note-images-v191';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=191',
  '/app-images.js?v=191',
  '/assets/catalog-1.js?v=191',
  '/assets/image-manifest.js?v=191',
  '/style.css?v=191',
  '/recipe.js?v=191',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v191] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v191] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
