// ============================================================
//  Cook Note - Service Worker PWA v432
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v432';
const IMAGE_CACHE_NAME = 'cook-note-images-v432';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=432-parent-title',
  '/app-techniques.js?v=432-parent-title',
  '/app-premium.js?v=432-parent-title',
  '/app-images.js?v=432-parent-title',
  '/app-art-images.js?v=432-parent-title',
  '/theme.js?v=432-parent-title',
  '/i18n.js?v=432-parent-title',
  '/assets/catalog-1.js?v=432-parent-title',
  '/assets/image-manifest.js?v=432-parent-title',
  '/style.css?v=432-parent-title',
  '/manifest.json',
