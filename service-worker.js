// ============================================================
//  Cook Note - Service Worker PWA v194
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v194';
const IMAGE_CACHE_NAME = 'cook-note-images-v194';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=194',
  '/app-images.js?v=194',
  '/assets/catalog-1.js?v=194',
  '/assets/image-manifest.js?v=194',
  '/style.css?v=194',
  '/recipe.js?v=194',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v194] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v194] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
