// ============================================================
//  Cook Note - Service Worker PWA v244
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v244';
const IMAGE_CACHE_NAME = 'cook-note-images-v244';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=244',
  '/app-images.js?v=244',
  '/assets/catalog-1.js?v=244',
  '/assets/image-manifest.js?v=244',
  '/style.css?v=244',
  '/recipe.js?v=244',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v244] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v244] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
