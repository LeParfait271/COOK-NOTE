// ============================================================
//  Cook Note - Service Worker PWA v180
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v180';
const IMAGE_CACHE_NAME = 'cook-note-images-v180';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=180',
  '/app-images.js?v=180',
  '/assets/catalog-1.js?v=180',
  '/assets/image-manifest.js?v=180',
  '/style.css?v=180',
  '/recipe.js?v=180',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v180] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v180] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
