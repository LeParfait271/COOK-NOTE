// ============================================================
//  Cook Note - Service Worker PWA v31
//  Cache-first pour assets statiques
//  Network-first pour les images externes (Unsplash, CDN)
// ============================================================

const CACHE_NAME = 'cook-note-v31';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/recipe.html',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v31] Assets statiques mis en cache.');
      })
  );
  self.skipWaiting();
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v31] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
