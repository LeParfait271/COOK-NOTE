// ============================================================
//  Cook Note - Service Worker PWA v201
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v201';
const IMAGE_CACHE_NAME = 'cook-note-images-v201';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=201',
  '/app-images.js?v=201',
  '/assets/catalog-1.js?v=201',
  '/assets/image-manifest.js?v=201',
  '/style.css?v=201',
  '/recipe.js?v=201',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v201] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v201] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
