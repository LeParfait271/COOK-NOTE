// ============================================================
//  Cook Note - Service Worker PWA v192
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v192';
const IMAGE_CACHE_NAME = 'cook-note-images-v192';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=192',
  '/app-images.js?v=192',
  '/assets/catalog-1.js?v=192',
  '/assets/image-manifest.js?v=192',
  '/style.css?v=192',
  '/recipe.js?v=192',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v192] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v192] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
