// ============================================================
//  Cook Note - Service Worker PWA v237
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v237';
const IMAGE_CACHE_NAME = 'cook-note-images-v237';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=237',
  '/app-images.js?v=237',
  '/assets/catalog-1.js?v=237',
  '/assets/image-manifest.js?v=237',
  '/style.css?v=237',
  '/recipe.js?v=237',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v237] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v237] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
