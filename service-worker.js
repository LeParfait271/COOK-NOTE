...
const STATIC_ASSETS = [
  ...
  '/recipe.html',
  '/app.js?v=148',
  '/assets/catalog-1.js?v=148',
  '/assets/catalog-2.js?v=148',
  '/assets/catalog-3.js?v=148',
  '/assets/catalog-4.js?v=148',
  '/assets/image-manifest.js?v=148',
  '/style.css?v=148',
  '/recipe.js?v=148',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v148] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v148] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
