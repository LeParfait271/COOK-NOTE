// ============================================================
//  Cook Note - Service Worker PWA v236
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v236';
const IMAGE_CACHE_NAME = 'cook-note-images-v236';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=236',
  '/app-images.js?v=236',
  '/assets/catalog-1.js?v=236',
  '/assets/image-manifest.js?v=236',
  '/style.css?v=236',
  '/recipe.js?v=236',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v236] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v236] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
