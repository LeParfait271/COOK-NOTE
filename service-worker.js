// ============================================================
//  Cook Note - Service Worker PWA v182
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v182';
const IMAGE_CACHE_NAME = 'cook-note-images-v182';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=182',
  '/app-images.js?v=182',
  '/assets/catalog-1.js?v=182',
  '/assets/image-manifest.js?v=182',
  '/style.css?v=182',
  '/recipe.js?v=182',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v182] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v182] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
