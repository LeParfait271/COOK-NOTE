// ============================================================
//  Cook Note - Service Worker PWA v366
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v366';
const IMAGE_CACHE_NAME = 'cook-note-images-v366';
...
const STATIC_ASSETS = [
  ...
  '/index.html',
  '/recipe.html',
  '/app.js?v=366-parent-title',
  '/app-techniques.js?v=366-parent-title',
  '/app-premium.js?v=366-parent-title',
  '/app-images.js?v=366-parent-title',
  '/app-art-images.js?v=366-parent-title',
  '/theme.js?v=366-parent-title',
  '/i18n.js?v=366-parent-title',
  '/assets/catalog-1.js?v=366-parent-title',
  '/assets/image-manifest.js?v=366-parent-title',
  '/style.css?v=366-parent-title',
  '/recipe.js?v=366-parent-title',
  '/manifest.json',
