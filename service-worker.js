// ============================================================
//  Cook Note - Service Worker PWA v518
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v518';
const IMAGE_CACHE_NAME = 'cook-note-images-v518';
...
const STATIC_ASSETS = [
  '/index.html',
  '/app.js?v=518-parent-title',
  '/app-techniques.js?v=518-parent-title',
  '/app-premium.js?v=518-parent-title',
  '/app-personal-tools.js?v=514-parent-title',
  '/app-images.js?v=518-parent-title',
  '/app-art-images.js?v=518-parent-title',
  '/app-inline-variant-rules.js?v=518-parent-title',
  '/theme.js?v=518-parent-title',
  '/i18n.js?v=518-parent-title',
  '/assets/catalog-1.js?v=518-parent-title',
  '/recipe-worker.js',
  '/assets/image-manifest.js?v=518-parent-title',
  '/style.css?v=518-parent-title',
  '/recipe-editorial.css?v=518-parent-title',
