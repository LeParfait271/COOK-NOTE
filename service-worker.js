// ============================================================
//  Cook Note - Service Worker PWA v225
//  Cache-first pour assets statiques
//  Network-first pour les pages et fichiers qui changent souvent
// ============================================================

const CACHE_NAME = 'cook-note-v225';
const IMAGE_CACHE_NAME = 'cook-note-images-v225';
...
const STATIC_ASSETS = [
  ...
  '/app.js?v=225',
  '/app-images.js?v=225',
  '/assets/catalog-1.js?v=225',
  '/assets/image-manifest.js?v=225',
  '/style.css?v=225',
  '/recipe.js?v=225',
  '/manifest.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('[SW v225] Assets statiques mis en cache.');
      })
  );
});
  ...
  event.waitUntil(
    caches.keys().then(keys =>
      Promise.all(
        ...
        console.log('[SW v225] Anciens caches supprimés.');
    })
  );
  self.clients.claim();
});
