...
- Le budget de `recipes.js` couvre la source d edition complete et peut accompagner la croissance documentee du catalogue ; il est fixe a 565 Ko depuis le lot de 5 recettes de juillet 2026. La performance publique reste protegee par les catalogues `assets/catalog-*.js`, chacun limite a 475 Ko et charge separement.
