...
- L'interface Android Legacy doit garder une lecture native claire : accueil compact, liste `ListView` recyclee avec titres ellipses, recherche et filtres caches dans un panneau replie, fiches organisees en sections, infos rapides en pastilles, ingredients en lignes lisibles, etapes numerotees, favoris, derniers ouverts, filtres saison/difficulte, copie ingredients, liste de courses locale, copie fiche et partage fiche. Ne pas remplacer cette mise en page par un rendu web ou par de longs blocs texte bruts.
