...
- L'app `Android 5.0+` peut reintegrer des fonctions utiles si elles restent natives et legeres : favoris locaux `SharedPreferences`, derniers ouverts, filtres saison/difficulte et copie ingredients. Ne pas les remplacer par WebView, React ou moteur web.
...
- L'interface Android Legacy doit garder une lecture native claire : liste `ListView` recyclee avec titres ellipses, fiches organisees en sections, infos rapides en pastilles, ingredients en lignes lisibles, etapes numerotees, favoris, derniers ouverts, filtres saison/difficulte et copie ingredients. Ne pas remplacer cette mise en page par un rendu web ou par de longs blocs texte bruts.
