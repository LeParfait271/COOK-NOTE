...
- L'interface Android Legacy doit garder une lecture native claire : liste `ListView` recyclee avec titres ellipses, fiches organisees en sections, infos rapides en pastilles, ingredients en lignes lisibles et etapes numerotees. Ne pas remplacer cette mise en page par un rendu web ou par de longs blocs texte bruts.
