...
- Le budget de `recipes.js` couvre la source d edition complete et peut accompagner la croissance documentee du catalogue ; il est fixe a 575 Ko depuis le lot Tarte aux fraises / Madeleines de juillet 2026. La performance publique reste protegee par les catalogues `assets/catalog-*.js`, chacun limite a 475 Ko et charge separement.
