...
- L'app `Android 5.0+` peut reintegrer des fonctions utiles si elles restent natives et legeres : favoris locaux `SharedPreferences`, derniers ouverts, filtres saison/difficulte, panneau recherche/filtres replie, copie ingredients, liste de courses locale, copie fiche, partage fiche et bouton natif de mise a jour vers `downloads/cook-note-android-legacy.apk`. Ne pas les remplacer par WebView, React ou moteur web.
