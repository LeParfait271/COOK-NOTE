...
function loadAdminPassword() {
  if (process.env.COOK_NOTE_ADMIN_PASSWORD) return process.env.COOK_NOTE_ADMIN_PASSWORD;
...
function staticCacheControl(filePath, noStore = false) {
  ...
  if (
    ...
    relative === 'app-personal-tools.js' ||
    relative === 'app-safety-sources.js' ||
    relative === 'theme.js' ||
    relative === 'i18n.js' ||
    relative === 'style.css' ||
    relative === 'recipe-editorial.css' ||
    relative === 'personal-tools.css' ||
    relative === 'restaurant-tools.css' ||
    relative === 'recipe-safety-sources.css' ||
    relative === 'recipe.js' ||
