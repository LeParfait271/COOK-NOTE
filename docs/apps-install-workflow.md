...
- Interface : `GridView` recyclee en cartes image 16/9 proches du site, accueil
  ...
  cibles image obsoletes liberees, prechauffage images differe, position de grille
