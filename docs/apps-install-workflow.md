...
- Direction visuelle Android Legacy : refonte visuelle native premium sans
  ...
  distinguees
- Theme Android Legacy : mode nuit reference, mode jour natif sobre et lisible,
  detection du theme systeme au premier lancement, preference persistante locale,
  aucune WebView et aucun CSS web pour piloter l APK.
