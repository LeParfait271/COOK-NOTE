...
- Interface : `GridView` recyclee en cartes image 16/9 proches du site, accueil
  ...
  image serialise, coalescence chargements image, position de grille conservee,
  liberation memoire de liste, pile retour bornee, courses cochables, audit perf
