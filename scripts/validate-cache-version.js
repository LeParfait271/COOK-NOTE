...
const assetVersions = [
  ...index.matchAll(/\b(?:app|app-images|theme|i18n|catalog-\d+|style)\.(?:js|css)\?v=(\d+)/g),
  ...
  ...serviceWorker.matchAll(/\b(?:app|app-images|theme|i18n|catalog-\d+|image-manifest|recipe|style)\.(?:js|css)\?v=(\d+)/g),
