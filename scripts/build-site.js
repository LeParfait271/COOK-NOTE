...
function renderStaticRecipePage(id, recipe, recipes, version) {
  ...
  return [
    ...
    `  <link rel="stylesheet" href="/restaurant-tools.css?v=${version}" />`,
    `  <link rel="stylesheet" href="/recipe-safety-sources.css?v=${version}" />`,
    ...
    `  <script src="/app-safety-sources.js?v=${version}"></script>`,
...
function writeDistImageManifest() {
  ...
  const text = `// Generated by scripts/build-site.js. Do not edit manually.\nwindow.COOK_NOTE_IMAGE_MANIFEST=Object.freeze(${JSON.stringify(productionManifest)});\n`;
