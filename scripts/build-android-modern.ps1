...
$AndroidDir = Join-Path $Root "android-modern"
...
if (-not $Java) {
  throw "Java/JDK introuvable. Installe JDK 17 puis relance scripts/build-android-modern.ps1."
}
...
Write-Host "APK Cook Note Android Modern OK: $ApkPath"
