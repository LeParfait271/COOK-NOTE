...
expect('Images parents ecrasees par les overrides theme.', files.app.includes('function usesOriginalParentImage(recipe)') && files.app.includes('return recipe.image || themeRecipeArtImage(recipe) ||') && files.rules.includes('Les fiches parents et collections gardent leur image de fiche'));
