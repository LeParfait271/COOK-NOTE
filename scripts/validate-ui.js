...
expect('Mode menu sans registre accords professionnels.', files.app.includes('MENU_PAIRING_RULES') && files.app.includes('creamy-sauce-needs-neutral-side') && files.rules.includes('tomate expressive interdite avec sauce cremeuse'));
...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v1.09'") && files.app.includes("const SITE_UPDATED_AT = '02/06/26'") && files.app.includes('site-footer-version'));
