...
expect('Precision cuilleres poids moyens absente.', files.app.includes('spoonPrecisionLabel') && files.app.includes('cuillères rases') && files.style.includes('.average-weight-note'));
