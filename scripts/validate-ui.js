...
expect('Emblemes Petit-dejeuner et Bases encore confondus.', files.app.includes("'petits-dejeuners': 'cup'") && files.app.includes("base: 'mortar'") && files.style.includes('.card-category-crest') && files.style.includes('right: 14px;'));
