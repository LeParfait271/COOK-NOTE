...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v0.93'") && files.app.includes("const SITE_UPDATED_AT = '29/05/26'") && files.app.includes('site-footer-version'));
