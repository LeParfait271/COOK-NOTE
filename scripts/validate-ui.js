...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v1.10'") && files.app.includes("const SITE_UPDATED_AT = '02/06/26'") && files.app.includes('site-footer-version'));
