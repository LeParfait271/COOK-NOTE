...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v2.44'") && files.app.includes("const SITE_UPDATED_AT = '30/06/26'") && files.app.includes('site-footer-version'));
