...
expect('Manifest images non charge ou non utilise.', files.index.includes('/assets/image-manifest.js?v=202') && files.index.includes('/app-images.js?v=202') && files.appImages.includes('IMAGE_MANIFEST') && files.appImages.includes('window.CookNoteImages') && files.app.includes('imageSizeAttrs(cardImage)') && files.app.includes('imageBackgroundStyle(recipe.image'));
...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v2.02'") && files.app.includes("const SITE_UPDATED_AT = '26/06/26'") && files.app.includes('site-footer-version'));
