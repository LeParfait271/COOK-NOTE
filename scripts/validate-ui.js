...
expect('Images parents racine sans bannieres verrouillees.', files.app.includes('function isRootCategoryParentRecipe(recipe)') && files.app.includes('return recipe.image || themeRecipeArtImage(recipe) ||') && files.app.includes('return themeRecipeArtImage(recipe) || recipe.image ||') && files.rules.includes('Les 8 fiches parents racine gardent leurs images `parent_*_moon`'));
