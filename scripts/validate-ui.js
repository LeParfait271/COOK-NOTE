...
expect('Manifest images non charge ou non utilise.', files.index.includes('/assets/image-manifest.js?v=180') && files.index.includes('/app-images.js?v=180') && files.appImages.includes('IMAGE_MANIFEST') && files.appImages.includes('window.CookNoteImages') && files.app.includes('imageSizeAttrs(cardImage)') && files.app.includes('imageBackgroundStyle(recipe.image'));
...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v1.80'") && files.app.includes("const SITE_UPDATED_AT = '25/06/26'") && files.app.includes('site-footer-version'));
...
expect('Bouton installation Android footer absent.', files.app.includes('ANDROID_APK_DOWNLOAD_URL') && files.app.includes('releases/latest/download/cook-note-android.apk') && files.app.includes('site-footer-install') && files.app.includes('Installer Android') && files.style.includes('.site-footer-actions') && files.style.includes('.site-footer-install'));
