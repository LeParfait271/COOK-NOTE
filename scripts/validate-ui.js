...
expect('CSS mobile nav incoherent.', files.style.includes('grid-template-columns: repeat(7, minmax(0, 1fr))') && files.app.includes('mobile-theme-toggle') && files.app.includes('h(LanguageSwitcher)') && files.style.includes('.mobile-bottom-nav .language-toggle'));
