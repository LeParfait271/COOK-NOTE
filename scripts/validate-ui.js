...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v0.89'") && files.app.includes("const SITE_UPDATED_AT = '28/05/26'") && files.app.includes('site-footer-version'));
