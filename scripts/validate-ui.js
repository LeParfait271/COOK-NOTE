...
expect('Manifest images non charge ou non utilise.', files.index.includes('/assets/image-manifest.js?v=152') && files.app.includes('IMAGE_MANIFEST') && files.app.includes('imageSizeAttrs(cardImage)') && files.app.includes('imageBackgroundStyle(recipe.image)'));
...
expect('Version footer absente.', files.app.includes("const SITE_VERSION = 'v1.52'") && files.app.includes("const SITE_UPDATED_AT = '22/06/26'") && files.app.includes('site-footer-version'));
