...
expect('Assets Legacy ancien WebView non branches.', validators.legacyAssets.includes('@babel/core') && validators.legacyAssets.includes('core-js-bundle.min.js') && validators.packageJson.includes('scripts/build-android-legacy-assets.js'));
