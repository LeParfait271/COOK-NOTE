...
expect('Assets Legacy ancien WebView non branches.', validators.legacyAssets.includes('@babel/core') && validators.legacyAssets.includes('core-js-bundle.min.js') && validators.legacyAssets.includes('legacyCss') && validators.legacyAssets.includes('color-mix') && validators.legacyAssets.includes('cook-note-legacy-error') && validators.packageJson.includes('scripts/build-android-legacy-assets.js'));
