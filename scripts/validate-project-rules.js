...
expect('Workflow Android manuel non documente.', validators.androidWorkflow.includes('projet secondaire') && validators.androidWorkflow.includes('ne se met pas a jour automatiquement') && validators.androidWorkflow.includes('npm run apps:update-all') && validators.androidWorkflow.includes('npm run apps:publish-all') && validators.androidWorkflow.includes('npm run android:legacy:update-apk') && validators.androidWorkflow.includes('npm run android:legacy:publish-release') && validators.androidWorkflow.includes('cook-note-android-legacy.apk') && validators.androidWorkflow.includes('Ne jamais publier un seul APK') && validators.androidWorkflow.includes('scripts/build-android-legacy-assets.js') && validators.androidWorkflow.includes('Native Lite') && validators.androidWorkflow.includes('recipes-lite.json') && validators.androidWorkflow.includes('480px') && validators.androidWorkflow.includes('960px') && validators.androidWorkflow.includes('detail-images') && validators.androidWorkflow.includes('jpeg-js') && validators.androidWorkflow.includes('ListView') && validators.androidWorkflow.includes('RGB_565') && validators.androidWorkflow.includes('pastilles') && validators.androidWorkflow.includes('etapes numerotees') && validators.androidWorkflow.includes('sans WebView systeme et sans GeckoView') && validators.androidWorkflow.includes('assets/www'));
expect('Workflow apps global non documente.', validators.appsWorkflow.includes('Android 5.0+') && validators.appsWorkflow.includes('Android 8.0+') && validators.appsWorkflow.includes('Cook Note Android 5.0+') && validators.appsWorkflow.includes('Cook Note HD Android 8.0+') && validators.appsWorkflow.includes('iOS ancien') && validators.appsWorkflow.includes('iOS recent') && validators.appsWorkflow.includes('cook-note-android-modern.apk') && validators.appsWorkflow.includes('apps-vX.YY') && validators.appsWorkflow.includes('github.com/LeParfait271/COOK-NOTE/raw/main/downloads') && validators.appsWorkflow.includes('raw.githubusercontent.com') && validators.appsWorkflow.includes('/downloads/') && validators.appsWorkflow.includes('npm run apps:update-all') && validators.appsWorkflow.includes('npm run apps:publish-all') && validators.appsWorkflow.includes('Mise a jour groupee obligatoire') && validators.appsWorkflow.includes('Ne jamais publier un seul APK') && validators.appsWorkflow.includes('scripts/build-android-legacy-assets.js') && validators.appsWorkflow.includes('Native Lite') && validators.appsWorkflow.includes('modern-app-hd') && validators.appsWorkflow.includes('CookNoteModernApp/HD') && validators.appsWorkflow.includes('recipes-lite.json') && validators.appsWorkflow.includes('480px') && validators.appsWorkflow.includes('960px') && validators.appsWorkflow.includes('jpeg-js') && validators.appsWorkflow.includes('ListView') && validators.appsWorkflow.includes('RGB_565') && validators.appsWorkflow.includes('pastilles') && validators.appsWorkflow.includes('etapes numerotees') && validators.appsWorkflow.includes('sans GeckoView'));
