(function initCookNoteI18n(global) {
  ...
  const messages = {
    fr: {
      ...
      'nav.searchShort': 'Rech',
      'nav.menu': 'Mode menu',
      'nav.menuShort': 'Menu',
      'nav.favorites': 'Favoris',
      'nav.favoritesShort': 'Fav',
      'nav.shopping': 'Courses',
      'nav.shoppingShort': 'Liste',
      'nav.day': 'Jour',
      'nav.night': 'Nuit',
      'nav.switchToDay': 'Passer en mode jour',
      'nav.switchToNight': 'Passer en mode nuit',
      ...
      'common.close': 'Fermer',
      'personal.kicker': 'Carnet personnel',
      'personal.title': 'Mes outils de cuisine',
      'personal.tabsAria': 'Outils personnels',
      'personal.tab.equipment': 'Mon matériel',
      'personal.tab.catalog': 'Recettes proches',
      'personal.openTools': 'Ouvrir mes outils',
      'personal.openToolsHelp': 'Renseignez votre matériel et comparez les recettes qui se ressemblent.',
      'personal.profileSaved': 'Profil de matériel enregistré.',
      'personal.equipmentHelp': 'Listez votre matériel séparé par des virgules. Cook Note signalera les éléments disponibles ou à vérifier dans chaque fiche.',
      'personal.equipmentList': 'Matériel disponible',
      'personal.equipmentPlaceholder': 'Robot, mixeur plongeant, thermomètre…',
      'personal.ovenOffset': 'Correction de température du four (°C)',
      'personal.roundMold': 'Moule rond habituel (cm)',
      'personal.rectWidth': 'Moule rectangulaire : largeur (cm)',
      'personal.rectLength': 'Moule rectangulaire : longueur (cm)',
      'personal.saveEquipment': 'Enregistrer mon matériel',
      'personal.similarHelp': 'Analyse locale des titres, ingrédients et familles pour repérer les fiches à comparer. Aucune recette n’est fusionnée automatiquement.',
      'personal.analyze': 'Analyser le catalogue',
      'personal.analysisLoading': 'Analyse en cours…',
      'personal.analysisEmpty': 'Lancez l’analyse pour afficher les rapprochements les plus utiles.',
      'personal.similarSameFamily': 'même famille',
      'personal.similarTitle': 'titre proche',
      'personal.similarIngredients': 'ingrédients communs',
      'personal.openFirst': 'Ouvrir la première',
      'personal.openSecond': 'Ouvrir la seconde',
      'personal.history': 'Historique de la fiche',
      'personal.historyAria': 'Historique local de cette recette',
      'personal.historyLocalActive': 'Une ancienne version est utilisée localement.',
      'personal.historyUsePublished': 'Revenir à la version publiée',
      'personal.historyHelp': 'Les quatre dernières versions consultées sont conservées sur cet appareil.',
      'personal.historyUnknownVersion': 'Version enregistrée',
      'personal.historyPublished': 'Version publiée actuelle',
      'personal.historyRestore': 'Restaurer localement',
      'personal.historyTitleChanged': 'titre modifié',
      'personal.historyIngredientDelta': '{direction}{count} ingrédient(s)',
      'personal.historyStepDelta': '{direction}{count} étape(s)',
      'personal.historyNotesChanged': 'notes modifiées',
      'personal.historyPracticalChanged': 'informations pratiques modifiées',
      'personal.historyDetailsChanged': 'contenu modifié',
      'personal.equipmentRecipe': 'Compatibilité avec mon matériel',
      'personal.equipmentRecipeAria': 'Compatibilité du matériel requis',
      'personal.equipmentOwned': 'Disponible',
      'personal.equipmentCheck': 'À vérifier',
      'personal.equipmentOvenOffset': 'Réglage conseillé : corriger le four de {offset} °C.',
      'personal.ratios': 'Ratios culinaires',
      'personal.ratiosAria': 'Ratios calculés pour cette recette',
      'personal.ratiosHelp': 'Repères calculés automatiquement à partir des quantités métriques de la fiche.',
      'personal.ratio.hydration': 'Hydratation',
      'personal.ratio.salt': 'Sel / farine',
      'personal.ratio.sugar': 'Sucre / farine',
      'personal.ratio.fat': 'Matière grasse / farine',
      'personal.ratio.oilPerYolk': 'Huile / jaune',
      'personal.ratio.gelatine': 'Gélatine / liquide',
      'personal.ratioMl': '{value} ml',
      'personal.mold': 'Adapter le contenant',
      'personal.moldAria': 'Calculateur de moules et contenants',
      'personal.moldHelp': 'Compare les surfaces pour ajuster toutes les quantités en une seule fois.',
      'personal.moldDiameter': 'Diamètre (cm)',
      'personal.moldWidth': 'Largeur (cm)',
      'personal.moldLength': 'Longueur (cm)',
      'personal.moldRound': 'Rond',
      'personal.moldRectangle': 'Rectangulaire',
      'personal.moldSource': 'Contenant de la recette',
      'personal.moldTarget': 'Mon contenant',
      'personal.moldFactor': 'Multiplier les quantités par {factor}',
      'personal.moldMore': '{percent} % de préparation en plus',
      'personal.moldLess': '{percent} % de préparation en moins',
      'personal.moldSame': 'Quantités inchangées',
      'personal.moldCaution': 'Le temps de cuisson reste à surveiller : la hauteur et la matière du contenant peuvent le modifier.',
      'personal.byproducts': 'Utiliser les restes utiles',
      'personal.byproductsHelp': 'Suggestions calculées depuis les sous-produits générés par cette recette.',
      'personal.byproduct.whites': 'Blancs d’œufs disponibles',
      'personal.byproduct.yolks': 'Jaunes d’œufs disponibles',
      'personal.byproduct.lemonJuice': 'Jus de citron disponible',
      'personal.byproductCount': '{count} recette(s) compatible(s)',
      'personal.byproductsNoMatch': 'Aucune recette compatible trouvée dans le catalogue.'
    },
    en: {
      ...
      'nav.home': 'Home',
      'nav.search': 'Search',
      'nav.searchShort': 'Find',
      'nav.menu': 'Menu mode',
      'nav.menuShort': 'Menu',
      'nav.favorites': 'Favorites',
      'nav.favoritesShort': 'Fav',
      'nav.shopping': 'Shopping',
      'nav.shoppingShort': 'List',
      'nav.day': 'Day',
      'nav.night': 'Night',
      'nav.switchToDay': 'Switch to day mode',
      'nav.switchToNight': 'Switch to night mode',
      ...
      'common.close': 'Close',
      'personal.kicker': 'Personal notebook',
      'personal.title': 'My kitchen tools',
      'personal.tabsAria': 'Personal tools',
      'personal.tab.equipment': 'My equipment',
      'personal.tab.catalog': 'Similar recipes',
      'personal.openTools': 'Open my tools',
      'personal.openToolsHelp': 'Save your equipment and compare recipes that resemble each other.',
      'personal.profileSaved': 'Equipment profile saved.',
      'personal.equipmentHelp': 'List equipment separated by commas. Cook Note will flag available items and items to check on each recipe.',
      'personal.equipmentList': 'Available equipment',
      'personal.equipmentPlaceholder': 'Stand mixer, hand blender, thermometer…',
      'personal.ovenOffset': 'Oven temperature correction (°C)',
      'personal.roundMold': 'Usual round tin (cm)',
      'personal.rectWidth': 'Rectangular tin width (cm)',
      'personal.rectLength': 'Rectangular tin length (cm)',
      'personal.saveEquipment': 'Save my equipment',
      'personal.similarHelp': 'Local analysis of titles, ingredients and families. Recipes are never merged automatically.',
      'personal.analyze': 'Analyze the catalog',
      'personal.analysisLoading': 'Analyzing…',
      'personal.analysisEmpty': 'Run the analysis to show the most useful comparisons.',
      'personal.similarSameFamily': 'same family',
      'personal.similarTitle': 'similar title',
      'personal.similarIngredients': 'shared ingredients',
      'personal.openFirst': 'Open first',
      'personal.openSecond': 'Open second',
      'personal.history': 'Recipe history',
      'personal.historyAria': 'Local history for this recipe',
      'personal.historyLocalActive': 'An older version is currently used locally.',
      'personal.historyUsePublished': 'Return to published version',
      'personal.historyHelp': 'The last four versions viewed are stored on this device.',
      'personal.historyUnknownVersion': 'Saved version',
      'personal.historyPublished': 'Current published version',
      'personal.historyRestore': 'Restore locally',
      'personal.historyTitleChanged': 'title changed',
      'personal.historyIngredientDelta': '{direction}{count} ingredient(s)',
      'personal.historyStepDelta': '{direction}{count} step(s)',
      'personal.historyNotesChanged': 'notes changed',
      'personal.historyPracticalChanged': 'practical information changed',
      'personal.historyDetailsChanged': 'content changed',
      'personal.equipmentRecipe': 'Compatibility with my equipment',
      'personal.equipmentRecipeAria': 'Required equipment compatibility',
      'personal.equipmentOwned': 'Available',
      'personal.equipmentCheck': 'Check',
      'personal.equipmentOvenOffset': 'Suggested setting: correct oven temperature by {offset}°C.',
      'personal.ratios': 'Cooking ratios',
      'personal.ratiosAria': 'Ratios calculated for this recipe',
      'personal.ratiosHelp': 'Reference values calculated from metric quantities in this recipe.',
      'personal.ratio.hydration': 'Hydration',
      'personal.ratio.salt': 'Salt / flour',
      'personal.ratio.sugar': 'Sugar / flour',
      'personal.ratio.fat': 'Fat / flour',
      'personal.ratio.oilPerYolk': 'Oil / yolk',
      'personal.ratio.gelatine': 'Gelatine / liquid',
      'personal.ratioMl': '{value} ml',
      'personal.mold': 'Adapt the container',
      'personal.moldAria': 'Tin and container calculator',
      'personal.moldHelp': 'Compares surface areas to adjust every quantity at once.',
      'personal.moldDiameter': 'Diameter (cm)',
      'personal.moldWidth': 'Width (cm)',
      'personal.moldLength': 'Length (cm)',
      'personal.moldRound': 'Round',
      'personal.moldRectangle': 'Rectangular',
      'personal.moldSource': 'Recipe container',
      'personal.moldTarget': 'My container',
      'personal.moldFactor': 'Multiply quantities by {factor}',
      'personal.moldMore': '{percent}% more mixture',
      'personal.moldLess': '{percent}% less mixture',
      'personal.moldSame': 'Quantities unchanged',
      'personal.moldCaution': 'Keep watching the cooking time: depth and material can change it.',
      'personal.byproducts': 'Use useful leftovers',
      'personal.byproductsHelp': 'Suggestions calculated from by-products generated by this recipe.',
      'personal.byproduct.whites': 'Egg whites available',
      'personal.byproduct.yolks': 'Egg yolks available',
      'personal.byproduct.lemonJuice': 'Lemon juice available',
      'personal.byproductCount': '{count} compatible recipe(s)',
      'personal.byproductsNoMatch': 'No compatible recipe found in the catalog.'
    }
  };
  ...
  const phraseEn = {
    ...
    'Accords, service, liste de courses': 'Pairings, service and shopping list',
    'Gestes, rep\u00e8res et bases': 'Gestures, cues and basics',
    'Fiches sauvegard\u00e9es': 'Saved recipe cards',
    'Commandes Cook Note': 'Cook Note commands',
    'Commande ou recette': 'Command or recipe',
    'Acc\u00e8s rapides': 'Quick access',
    'Recherche compl\u00e8te': 'Full search',
    'Catalogue': 'Catalog',
    'Recettes': 'Recipes',
    'Aucune fiche directe': 'No direct recipe card',
    'La recherche compl\u00e8te prendra le relais.': 'Full search will take over.',
    ...
    'Rechercher': 'Search',
    'Gestes de cuisine': 'Cooking techniques',
    'Technique de cuisinier': 'Cooking technique',
    'Agrumes': 'Citrus',
    'Chocolat': 'Chocolate',
    'Conserve': 'Preserving',
    'Geste': 'Technique',
    ...
    'Continuer avec cette variante': 'Continue with this variant',
    'Repères complémentaires': 'Additional references',
    ...
    'Accords': 'Pairings',
    'Ingrédients utiles': 'Useful ingredients',
    'Dressage': 'Plating',
    ...
    'Recettes liées à cette fiche': 'Recipes related to this sheet',
    'Accords de la recette': 'Recipe pairings',
    'Conseils ingrédients': 'Ingredient guidance',
    'Organisation de la préparation': 'Preparation organization',
    'Notes de la recette': 'Recipe notes',
    'Mémo': 'Memo',
    ...
    'Choisis une variante': 'Choose a variant',
    'Variante active': 'Active variant',
    'Variante sélectionnée': 'Selected variant',
    ...
    'Choix requis pour ouvrir la fiche': 'Choose a variant to open the recipe',
    'Chaque choix ouvre une recette complète avec ses propres ingrédients, étapes, quantités et conseils.': 'Each choice opens a complete recipe with its own ingredients, steps, quantities and tips.',
    'Choisis une carte ci-dessus': 'Choose a card above',
    'La fiche complète s’affichera ensuite, sans mélanger les recettes.': 'The full recipe will then appear, without mixing recipes.',
    'Ingrédients, étapes, quantités et conseils correspondent maintenant à ce choix.': 'Ingredients, steps, quantities and tips now match this choice.',
    ...
    'Affichage': 'Display',
    'Texte plus lisible': 'More readable text',
    'Agrandit l\u00e9g\u00e8rement les fiches et les panneaux.': 'Slightly enlarges recipe cards and panels.',
    'Animations calmes': 'Calm animations',
    'R\u00e9duit les mouvements sans enlever les lumi\u00e8res du th\u00e8me.': 'Reduces motion without removing the theme\'s glow.',
    'Sauvegarde locale': 'Local backup',
    'Exporte ou restaure tes favoris, notes et listes de courses sur cet appareil.': 'Export or restore your favorites, notes and shopping lists on this device.',
    'Exporter': 'Export',
    'Importer': 'Import',
    'Exporter les donn\u00e9es locales': 'Export local data',
    'Importer une sauvegarde locale': 'Import a local backup',
    'Favoris hors-ligne': 'Offline favorites',
    'Pr\u00e9charger les recettes favorites hors-ligne': 'Preload favorite recipes offline',
    'Mes recettes favorites': 'My favorite recipes',
    'Quitter les favoris': 'Exit favorites',
    'Collections de favoris': 'Favorite collections',
    'Proposer une fiche': 'Suggest a recipe',
    'Rapide': 'Quick',
    'Saisissez un plat, un ingrédient ou une envie.': 'Enter a dish, ingredient or craving.',
    'Tout': 'All',
    ...
    'Ajoute une recette depuis sa fiche pour construire une liste groupée.': 'Add a recipe from its sheet to build a grouped list.',
    ...
    'Panier courses': 'Shopping basket',
    'Aucune recette': 'No recipe',
    'Tout afficher': 'Show all',
    'Frais seulement': 'Fresh only',
    'traité': 'handled',
    'frais': 'fresh',
    'trajet': 'trip',
    'Aucun': 'None',
    ...
    '\u0153ufs': 'eggs',
    'oeufs': 'eggs',
    'Vanille g\u00e9n\u00e9reuse, selon dosage': 'Generous vanilla, according to dosage',
    'achat': 'buy',
    'plaquette': 'pack',
    'paquet': 'pack',
    'bo\u00eete': 'box',
    'bo\u00eetes de 6': 'boxes of 6',
    '\u00e0 l\u2019unit\u00e9': 'per item',
    'vrac': 'loose',
    'sauce chili douce': 'sweet chili sauce',
    'sauce soja': 'soy sauce',
    'Batch': 'Batch',
    'Ordre de préparation': 'Preparation order',
    'Aucun achat frais': 'No fresh items',
    'Les recettes cochées sont couvertes par les rayons secs ou par ce qui est déjà à la maison.': 'The selected recipes are covered by pantry aisles or items already at home.',
    'Déjà à la maison': 'Already at home',
    'maison': 'home',
    'Copié': 'Copied',
    'Copier la liste complète': 'Copy full list',
    'Copier compact': 'Copy compact list',
    'Vider le panier': 'Empty basket',
    'Liste compacte copiée': 'Compact list copied',
    'Liste de courses copiée': 'Shopping list copied',
    'Courses Cook Note': 'Cook Note shopping',
    'Aucune recette.': 'No recipe.',
    'Liste de courses Cook Note': 'Cook Note shopping list',
    'Aucune recette cochée.': 'No recipe selected.',
    'Ingrédients regroupés': 'Grouped ingredients',
    'Regroupements utiles': 'Useful groupings',
    'Détail par recette': 'By-recipe detail',
    'pour': 'for',
    'personnes': 'people',
    ...
    'Aucune recette favorite pour le moment': 'No favorite recipes yet',
    'Ouvre une fiche puis utilise « Favori » pour la retrouver ici.': 'Open a recipe, then use “Favorite” to find it here.',
    ...
    'Servir tartinable après quelques minutes hors du froid, selon l’usage.': 'Serve spreadable after a few minutes out of the fridge, depending on use.',
    'Saler ou finir juste avant d’envoyer pour garder le croustillant.': 'Salt or finish just before serving to keep it crisp.',
    'Saler et terminer juste avant le service pour préserver le croustillant.': 'Salt and finish just before serving to preserve crispness.',
    'Faire les finitions au dernier moment.': 'Add the finishing touches at the last moment.',
    'Garder au froid jusqu’au service.': 'Keep chilled until serving.',
    'Maintenir l’huile à bonne température et égoutter aussitôt.': 'Keep the oil at the right temperature and drain immediately.',
    'Vérifier la fraîcheur et la cuisson des produits de la mer.': 'Check seafood freshness and doneness.',
    'Vérifier la cuisson de la viande avant le service.': 'Check the meat is cooked before serving.',
    'Utiliser des œufs très frais et conserver au froid.': 'Use very fresh eggs and keep chilled.',
    'Respecter l’hygiène et la conservation au froid.': 'Follow hygiene and cold-storage rules.',
    ...
    'Composer un repas': 'Plan a meal',
    'Autre menu': 'Another menu',
    'Proposer un autre menu complet': 'Suggest another full menu',
    'Filtrer les gestes': 'Filter techniques',
    'Filtrer les techniques': 'Filter techniques',
    'Les gestes de base pour cuisiner plus proprement : tailler, peler, abaisser, foncer, monter, lier et éviter les erreurs classiques.': 'Core techniques for cleaner cooking: cutting, peeling, rolling, lining, whipping, binding and avoiding common mistakes.',
    'Cuisson douce': 'Gentle cooking',
    'Assaisonnement': 'Seasoning',
    'Riz': 'Rice',
    'Four': 'Oven',
    'Couteau': 'Knife',
    'Légumes': 'Vegetables',
    'Moule': 'Pan and moulds',
    'Poisson': 'Fish',
    'Égouttage': 'Draining',
    'Bistrot': 'Bistro',
    'Méditerranéen': 'Mediterranean',
    'Soir de semaine': 'Weeknight',
    'Invités': 'Guests',
    'Apéro dînatoire': 'Dinner party',
    'Été frais': 'Fresh summer',
    'Classique chaud, sauce lisible, dessert de pâtisserie.': 'Warm classic dishes, clear sauces and a pastry dessert.',
    'Tomate, citron, huile d’olive, herbes et fraîcheur.': 'Tomato, lemon, olive oil, herbs and freshness.',
    'Simple, rapide, peu de gestes et courses raisonnables.': 'Simple, quick, few steps and a sensible shopping list.',
    'Préparable, équilibré, avec un dessert qui tient bien.': 'Make-ahead, balanced and finished with a dessert that holds well.',
    'Petites pièces, dips, fromages et choses à picorer.': 'Small bites, dips, cheese and things to graze on.',
    'Gourmand, chaud, généreux, sans empiler deux féculents.': 'Warm, generous comfort food without stacking two starches.',
    'Froid, acidulé, végétal, avec une fin légère.': 'Cool, bright and plant-forward, with a light finish.',
    'Les quantités du menu et des courses suivent ce nombre.': 'Menu and shopping quantities follow this number.',
    'Menu simple à coordonner.': 'Simple menu to coordinate.',
    'Fil conducteur : menu cohérent.': 'A coherent menu thread.',
    'Menu équilibré.': 'Balanced menu.',
    'Rôles à composer': 'Roles to build',
    'Mode menu': 'Menu mode',
    'Personnes': 'People',
    ...
    'personnes': 'people',
    'Qualité du menu': 'Menu quality',
    'Service fluide': 'Smooth service',
    'Accord solide': 'Solid pairing',
    'Menu correct': 'Good menu',
    'À affiner': 'Needs refining',
    'Cohérence': 'Coherence',
    'Charge': 'Workload',
    'fiches': 'recipe cards',
    'articles groupés': 'grouped items',
    'rayons': 'aisles',
    'À faire en avance': 'Prepare in advance',
    'Démarrer le repas': 'Start the meal',
    'Pendant les cuissons': 'While cooking',
    ...
    'Service': 'Service',
    'Matériel': 'Equipment',
    'A faire en avance': 'Prepare in advance',
    'Ouvre le menu sans alourdir le plat.': 'Open the menu without making the dish heavier.',
    'Base principale solide pour construire le repas.': 'A solid main course to build the meal around.',
    'Accompagnement logique avec la viande.': 'A natural side for the meat.',
    'Fin plus fraîche après le salé.': 'A fresher finish after the savory course.',
   'Ajouter le menu aux courses': 'Add menu to shopping list',
    'Ouvrir': 'Open',
    'Changer': 'Change',
    'Échine de porc en tranches': 'Pork loin steaks',
    'menthe fraîche': 'fresh mint',
    'persil séché': 'dried parsley',
    'À acheter frais': 'Fresh items to buy',
    'Épicerie à vérifier': 'Pantry to check',
    'Rayons principaux': 'Main aisles',
    'Primeur': 'Greengrocer',
    'Crèmerie et œufs': 'Dairy and eggs',
    'Boucherie': 'Butcher',
    'Épicerie salée': 'Savory pantry',
    'Citron restant : vinaigrette, marinade express ou zestes sur un dessert.': 'Leftover lemon: vinaigrette, quick marinade or zest over dessert.',
    'Herbes/légumes frais : salade du lendemain ou garniture de sandwich.': 'Fresh herbs/vegetables: next-day salad or sandwich filling.',
    'Prévoir une portion en plus du plat principal pour un repas simple le lendemain.': 'Plan one extra main-course portion for an easy meal the next day.',
    'Servir bien frais, assiette froide si possible.': 'Serve well chilled, on a cold plate if possible.',
    'Envoyer aussitôt pour garder le croustillant.': 'Serve immediately to keep it crisp.',
    'Sortir avant service si besoin pour retrouver la bonne texture.': 'Take out before serving if needed to restore the right texture.',
   'Four partagé': 'Shared oven',
    'Grillades porc miel orange piment, viande': 'Pork grills with orange, honey and chili, meat',
    'Galettes de légumes au Comté : Servir bien frais, assiette froide si possible.': 'Galettes of vegetables with Comté: Serve well chilled, on a cold plate if possible.',
    'Grillades porc miel orange piment : Servir bien frais, assiette froide si possible.': 'Pork grills with orange, honey and chili: Serve well chilled, on a cold plate if possible.',
    'Potato wedges citron herbes : Envoyer aussitôt pour garder le croustillant.': 'Potato wedges with lemon and herbs: Serve immediately to keep it crisp.',
    'Fraises marinées et tuiles de cacao : Sortir avant service si besoin pour retrouver la bonne texture.': 'Marinated strawberries and cocoa tuiles: Take out before serving if needed to restore the right texture.',
    'cuissons à coordonner': 'cooking tasks to coordinate',
    'Page introuvable': 'Page not found',
    'Cette fiche n’existe pas encore': 'This recipe page does not exist yet',
    'Le lien pointe vers une recette absente du carnet ou déplacée.': 'This link points to a recipe that is missing from the notebook or has moved.',
    'Rechercher une recette': 'Search for a recipe',
    'Choisir le style Bistrot': 'Choose Bistro style',
    'Choisir le style Méditerranéen': 'Choose Mediterranean style',
    'Choisir le style Soir de semaine': 'Choose Weeknight style',
    'Choisir le style Invités': 'Choose Guests style',
    'Choisir le style Apéro dînatoire': 'Choose Dinner party style',
    'Choisir le style Confort': 'Choose Comfort style',
    'Choisir le style Été frais': 'Choose Fresh summer style',
    'Préchauffer le four': 'Preheat the oven',
    'Chauffer une poêle': 'Heat a frying pan',
    'Émincer': 'Slice thinly',
    'Peler à vif': 'Supreme citrus',
    'Sabler': 'Rub in butter',
    'Chemiser': 'Line a mould',
    'Rafraîchir': 'Refresh and cool',
    'Paner': 'Bread and coat',
    'Étuver': 'Sweat gently',
    'Clarifier': 'Clarify',
    'Torréfier': 'Toast',
    'Parer': 'Trim',
    'Singer': 'Dust with flour',
    'Macaroner': 'Macaronage',
    'Stériliser': 'Sterilize',
    'Flamber': 'Flambé',
    'Saisir': 'Sear',
    'Mijoter / frémir': 'Simmer gently',
    'Trop fraiser développe le gluten et rend la pâte moins friable.': 'Overworking the dough develops gluten and makes it less crumbly.',
    'Des blancs trop battus deviennent granuleux et s’incorporent moins bien.': 'Over-whipped egg whites become grainy and are harder to fold in.',
    'Des blancs trop battus deviennent granuleux et s\'incorporent moins bien.': 'Over-whipped egg whites become grainy and are harder to fold in.',
    'Serrer trop tôt ralentit la montée ; serrer trop tard stabilise moins bien la mousse.': 'Adding sugar too early slows the rise; adding it too late stabilizes the foam less effectively.',
    'Tempérer protège les jaunes dans les crèmes, sauces et appareils.': 'Tempering protects the yolks in creams, sauces and mixtures.',
    'Faire fondre': 'Melt',
    'Fouetter': 'Whisk',
    'Mixer': 'Blend',
    ...
    'Égoutter': 'Drain',
    'Presser': 'Press',
    'Rectifier l’assaisonnement': 'Adjust the seasoning',
    'Dresser': 'Plate',
    'Arroser en cuisson': 'Baste during cooking',
    'Retourner à mi-cuisson': 'Turn halfway through cooking',
    'Rôtir': 'Roast',
    'Griller': 'Grill',
    ...
    'Braiser': 'Braise',
    'Rissoler': 'Brown',
    'Glacer des légumes': 'Glaze vegetables',
    'Laquer': 'Glaze',
    'Nacrer le riz': 'Toast the rice',
    'Mouiller': 'Add liquid',
    'Porter à ébullition': 'Bring to a boil',
    'Cuire à couvert': 'Cook covered',
    'Cuire à découvert': 'Cook uncovered',
    'Piquer une pâte': 'Dock pastry',
    'Dorer à l’œuf': 'Egg wash',
    ...
    'Dessécher une panade': 'Dry out a panade',
    'Chiqueter': 'Notch pastry',
    'Tourer une pâte': 'Laminate pastry',
    'Dégazer une pâte': 'Knock back dough',
    'Façonner / bouler': 'Shape and round dough',
    'Faire pousser une pâte': 'Proof dough',
    'Scarifier': 'Score dough',
    ...
    'Pincer les sucs': 'Caramelize the pan juices',
    'Décortiquer': 'Shell seafood',
    'Lever des filets': 'Fillet a fish',
    'Étaler une pâte au rouleau avec une épaisseur régulière, sans la réchauffer ni la déformer.': 'Roll pastry to an even thickness without warming or deforming it.',
    'Farine légèrement le plan de travail.': 'Lightly flour the work surface.',
    'Étale du centre vers l’extérieur.': 'Roll from the center outward.',
    'Tourne la pâte régulièrement.': 'Turn the pastry regularly.',
    'Remets au frais si elle devient collante.': 'Chill it again if it becomes sticky.',
    'Une pâte trop farinée devient sèche ; une pâte trop chaude se rétracte davantage.': 'Too much flour makes pastry dry; pastry that is too warm shrinks more.',
    'Installer une pâte dans un cercle ou un moule en gardant les angles propres.': 'Fit pastry into a ring or mould while keeping the corners clean.',
    'Dépose la pâte abaissée sans tirer.': 'Lay in the rolled pastry without pulling it.',
    'Pousse délicatement dans les angles.': 'Gently press it into the corners.',
    'Coupe l’excédent.': 'Trim the excess.',
    'Pique et remets au froid si besoin.': 'Dock it and chill again if needed.',
    'Ne tire pas sur la pâte : elle se rétracterait à la cuisson.': 'Do not pull the pastry: it will shrink during baking.',
    'Précuire une pâte seule avant d’ajouter une garniture humide ou fragile.': 'Part-bake pastry before adding a wet or delicate filling.',
    'Fonce et pique la pâte.': 'Fit and dock the pastry.',
    'Couvre de papier cuisson.': 'Cover with parchment paper.',
    'Ajoute des poids ou légumes secs.': 'Add baking weights or dried beans.',
    'Cuis jusqu’à légère coloration puis sèche sans poids si besoin.': 'Bake until lightly colored, then finish without the weights if needed.',
    'Le froid avant cuisson limite la rétractation.': 'Chilling before baking limits shrinkage.',
    'Mélanger farine et beurre pour obtenir une texture sableuse avant d’hydrater ou lier une pâte.': 'Rub flour and butter together for a sandy texture before adding liquid or binding the dough.',
    'Mets farine et beurre froid en morceaux.': 'Add flour and cold butter in pieces.',
    'Frotte entre les doigts ou au robot.': 'Rub between your fingers or in a mixer.',
    'Arrête dès que la texture ressemble à du sable.': 'Stop as soon as the texture looks like sand.',
    'Ajoute le liquide ou l’œuf ensuite.': 'Add the liquid or egg afterwards.',
    'Ne chauffe pas trop le beurre, sinon la pâte perd son côté friable.': 'Do not warm the butter too much or the pastry will lose its crumbly texture.',
    'Appliquer une fine couche de dorure, marinade, beurre, huile, miel ou moutarde sur une surface avec un pinceau.': 'Brush a thin layer of egg wash, marinade, butter, oil, honey or mustard over a surface.',
    'Prépare le mélange dans un petit bol.': 'Prepare the mixture in a small bowl.',
    'Utilise un pinceau de cuisine propre.': 'Use a clean pastry brush.',
    'Étale en couche fine et régulière.': 'Brush on a thin, even layer.',
    ...
    'Pour les légumes, plonge dans l’eau bouillante salée.': 'For vegetables, plunge them into salted boiling water.',
    'Cuis très peu de temps.': 'Cook for a very short time.',
    'Rafraîchis aussitôt si besoin.': 'Cool immediately in cold water if needed.',
    'Pour les œufs, fouette avec le sucre jusqu’à texture plus claire.': 'For eggs, whisk with sugar until lighter in color.',
    'Le contexte dit tout : légumes blanchis ou œufs blanchis ne veulent pas dire la même chose.': 'Context matters: blanched vegetables and whisked eggs are not the same technique.',
    'Abaisser une pâte': 'Roll out pastry',
    'Cuire à blanc': 'Blind-bake pastry',
    'Crèmer': 'Cream butter and sugar',
    'Marquer le bord d’une pâte feuilletée ou d’une tourte pour souder et décorer.': 'Mark the edge of puff pastry or a pie to seal and decorate it.',
    'Soude les bords avant de marquer.': 'Seal the edges before notching them.',
    'Utilise le dos d’un couteau.': 'Use the back of a knife.',
    'Fais de petites entailles régulières sans couper complètement.': 'Make small, even cuts without cutting all the way through.',
    'Refroidis si la pâte devient molle.': 'Chill it if the pastry becomes soft.',
    'Chiqueter aide aussi à contrôler le développement des bords feuilletés.': 'Notching also helps control how the pastry edges rise.',
    'Travailler beurre pommade et sucre pour obtenir une base souple et homogène.': 'Work softened butter and sugar into a smooth, flexible base.',
    'Utilise un beurre pommade, pas fondu.': 'Use softened butter, not melted butter.',
    'Travaille avec le sucre jusqu’à texture crémeuse.': 'Work in the sugar until creamy.',
    'Racle les bords du bol.': 'Scrape down the sides of the bowl.',
    'Ajoute les œufs ensuite selon la recette.': 'Add the eggs afterwards as directed by the recipe.',
    'Trop crémer peut changer la texture finale de certains cakes ou cookies.': 'Over-creaming can change the final texture of some cakes or cookies.',
    'Cuire une pâte riche en eau sur le feu pour retirer l’humidité avant d’ajouter les œufs.': 'Cook a water-rich dough on the hob to remove moisture before adding the eggs.',
    'Mélange sur feu moyen avec une spatule.': 'Stir over medium heat with a spatula.',
    'Cherche une pâte qui se détache des parois.': 'Look for a dough that pulls away from the sides.',
    'Observe un léger dépôt au fond de la casserole.': 'Look for a light film on the bottom of the pan.',
    ...
    'Passe une couche fine au pinceau.': 'Brush on a thin layer.',
    'Évite les coulures sur les bords feuilletés.': 'Avoid drips on puff-pastry edges.',
    'Laisse sécher quelques minutes si une seconde couche est prévue.': 'Let it dry for a few minutes if a second coat is planned.',
    'Les coulures de dorure peuvent coller les feuilletages et gêner leur développement.': 'Egg-wash drips can glue laminated layers together and stop them rising properly.',
    'Créer des couches régulières de pâte et de beurre par pliages successifs.': 'Create even layers of dough and butter through successive folds.',
    'Garde pâte et beurre à textures proches.': 'Keep the dough and butter at a similar consistency.',
    'Abaisse sans écraser le beurre.': 'Roll out without crushing the butter.',
    'Plie selon le tour demandé.': 'Fold according to the required turn.',
    'Respecte les temps de froid entre les tours.': 'Respect the chilling times between turns.',
    'Tourer trop chaud fait sortir le beurre ; trop froid, il casse et donne un feuilletage irrégulier.': 'Laminating when too warm makes the butter leak; when too cold, it cracks and creates uneven layers.',
    '4 cuisses de canard confites': '4 duck confit legs',
    '300g poitrine de porc': '300g pork belly',
    '180g carotte': '180g carrot',
    '180g oignon': '180g onion',
    "4 gousses d'ail": '4 garlic cloves',
    '60g graisse de canard': '60g duck fat',
    '80g chapelure': '80g breadcrumbs',
    'Poivre du moulin': 'Freshly ground pepper',
    'Écumoire': 'Slotted spoon',
    'Ecumoire': 'Slotted spoon',
    'Faire tremper les haricots une nuit, puis les égoutter.': 'Soak the beans overnight, then drain them.',
    "Faire tremper les haricots une nuit, puis les egoutter.": 'Soak the beans overnight, then drain them.',
    'Les précuire avec carotte, oignon, ail et bouquet garni jusqu’à tendreté presque complète.': 'Par-cook them with carrot, onion, garlic and bouquet garni until almost tender.',
    'Faire dorer saucisse et poitrine.': 'Brown the sausage and pork belly.',
    'Monter le cassoulet avec haricots, viandes, graisse de canard et assez de bouillon de cuisson pour affleurer.': 'Assemble the cassoulet with beans, meat, duck fat and enough cooking stock to come level.',
    'Cuire longtemps a 150C, en cassant la croute plusieurs fois.': 'Cook slowly at 150C, breaking the crust several times.',
    'Ajouter chapelure en fin de cuisson pour obtenir une surface dorée.': 'Add breadcrumbs at the end of cooking for a golden surface.',
    'Repère menu : plat très riche, prévoir une salade amère et un dessert frais.': 'Menu note: this is a rich dish; plan a bitter salad and a fresh dessert.',
    'Conservation : 3 jours au réfrigérateur; il gagne en goût après repos.': 'Storage: 3 days refrigerated; it improves in flavor after resting.',
    'Sécurité : refroidir en portions peu profondes avant de mettre au froid.': 'Safety: cool in shallow portions before refrigerating.',
    'Haricots fondants mais entiers, jus lie, croute dorée et viandes confites.': 'Beans tender but intact, juices lightly bound, golden crust and confit meats.'
  };

  const recipePhraseEn = {
    'Blanc de volaille farci au barbecue': 'Barbecue-stuffed chicken breast',
    'Brochettes de boulettes tsukune': 'Tsukune meatball skewers',
    'Brochettes de lotte au chorizo à la plancha': 'Monkfish and chorizo skewers on the plancha',
    'Carpaccio de bœuf': 'Beef carpaccio',
    'Carré d’agneau croûte d’herbes': 'Herb-crusted rack of lamb',
    'Cassolette de crevettes et ravioles au persil': 'Shrimp and parsley ravioli casserole',
    'Coq au vin': 'Coq au vin',
    'Courge butternut farcie': 'Stuffed butternut squash',
    'Currys végétariens': 'Vegetarian curries',
    'Dhal lentilles épices': 'Spiced lentil dhal',
    'Bavette de bœuf au chili rub': 'Beef bavette with chili rub',
    'Crevettes à la provençale': 'Provençal shrimp',
    'Chipirons à la plancha': 'Plancha-cooked baby squid',
    'Encornets sautes au chorizo': 'Squid sautéed with chorizo',
    'Cabillaud au four, crumble de chorizo': 'Baked cod with chorizo crumble',
    'Gratin de pâtes au chorizo': 'Chorizo pasta bake',
    'Pâtes au crumble de chorizo': 'Pasta with chorizo crumble',
    'Jarret de bœuf braisé à la bière': 'Beer-braised beef shank',
    'Cuisses de poulet': 'Chicken thighs',
    'Joues mijotées': 'Slow-cooked cheeks',
    'Saucisses aux lentilles': 'Sausages with lentils',
    'Ragoûts de bœuf à la bière': 'Beef and beer stews',
    'Légumineuses à la Montbéliard': 'Legumes with Montbéliard sausage',
    'Navarin d’agneau printanier': 'Spring lamb navarin',
    'Filet mignon de porc farci aux épinards': 'Spinach-stuffed pork tenderloin',
    'Poulet au vin jaune': 'Chicken in yellow wine sauce',
    'Poulet Marengo': 'Chicken Marengo',
    'Lapin sauté chasseur': 'Hunter-style sautéed rabbit',
    'Osso buco de veau': 'Veal osso buco',
    'Parmentier de confit de canard et patates douces': 'Duck confit and sweet potato shepherd’s pie',
    'Jarret d’agneau braisé aux petits légumes': 'Braised lamb shank with baby vegetables',
    'Queue de bœuf aux carottes et vin rouge': 'Oxtail with carrots and red wine',
    'Piperade œuf au plat': 'Piperade with fried egg',
    'Écrasée de pommes de terre à l’huile de truffe et Saint-Jacques': 'Truffled mashed potatoes with scallops',
    'Soupe paysanne à la saucisse de Morteau': 'Country soup with Morteau sausage',
    'Pâtes à la carbonara': 'Carbonara pasta',
    'Pâtes au pesto, tomates cerises et mozzarella': 'Pesto pasta with cherry tomatoes and mozzarella',
    'Macaronis du chalet': 'Chalet macaroni',
    'Pâtes brocolis amandes': 'Broccoli and almond pasta',
    'Poulet Gaston Gérard': 'Chicken Gaston Gérard',
    'Sauce au porto': 'Port wine sauce',
    'Sauce aux morilles': 'Morel mushroom sauce',
    'Sauce deux moutardes et fromage blanc': 'Two-mustard and fromage blanc sauce',
    'Cassoulet': 'Cassoulet',
    '650g haricots blancs secs trempes': '650g dried white beans, soaked',
    '650g haricots blancs secs trempés': '650g dried white beans, soaked',
    '4 cuisses de canard confit': '4 duck confit legs',
    '4 cuisses de canard confites': '4 duck confit legs',
    '500g saucisse de Toulouse': '500g Toulouse sausage',
    '300g poitrine de porc': '300g pork belly',
    '180g carotte': '180g carrot',
    '180g oignon': '180g onion',
    "4 gousses d'ail": '4 garlic cloves',
    ...
    'Ecumoire': 'Slotted spoon',
    'Écumoire': 'Slotted spoon',
    'Faire tremper les haricots blancs secs pendant 12h dans un grand volume d’eau froide.': 'Soak the dried white beans for 12 hours in plenty of cold water.',
    'Faire tremper les haricots blancs secs pendant 12h dans un grand volume d\'eau froide.': 'Soak the dried white beans for 12 hours in plenty of cold water.',
    'Les précuire dans une eau neuve pendant 45min, puis égoutter.': 'Par-cook them in fresh water for 45 minutes, then drain.',
    'Les precuire dans une eau neuve pendant 45min, puis egoutter.': 'Par-cook them in fresh water for 45 minutes, then drain.',
    'Faire tremper les haricots une nuit, puis les égoutter.': 'Soak the beans overnight, then drain them.',
    "Faire tremper les haricots une nuit, puis les egoutter.": 'Soak the beans overnight, then drain them.',
    'Les précuire avec carotte, oignon, ail et bouquet garni jusqu’à tendreté presque complète.': 'Par-cook them with carrot, onion, garlic and bouquet garni until almost tender.',
    'Les precuire avec carotte, oignon, ail et bouquet garni jusqu’a tendrete presque complete.': 'Par-cook them with carrot, onion, garlic and bouquet garni until almost tender.',
    'Faire dorer saucisse et poitrine.': 'Brown the sausage and pork belly.',
    'Monter le cassoulet avec haricots, viandes, graisse de canard et assez de bouillon de cuisson pour affleurer.': 'Assemble the cassoulet with beans, meat, duck fat and enough cooking stock to come level.',
    'Cuire longtemps a 150C, en cassant la croute plusieurs fois.': 'Cook slowly at 150C, breaking the crust several times.',
    'Cuire longtemps à 150°C, en cassant la croûte plusieurs fois.': 'Cook slowly at 150C, breaking the crust several times.',
    'Ajouter chapelure en fin de cuisson pour obtenir une surface dorée.': 'Add breadcrumbs at the end of cooking for a golden surface.',
    'Repère menu : plat très riche, prévoir une salade amère et un dessert frais.': 'Menu note: this is a rich dish; plan a bitter salad and a fresh dessert.',
    'Conservation : 3 jours au réfrigérateur; il gagne en goût après repos.': 'Storage: 3 days refrigerated; it improves in flavor after resting.',
    'Sécurité : refroidir en portions peu profondes avant de mettre au froid.': 'Safety: cool in shallow portions before refrigerating.',
    'Haricots fondants mais entiers, jus lie, croute dorée et viandes confites.': 'Beans tender but intact, juices lightly bound, golden crust and confit meats.',
    'Haricots fondants mais entiers, jus lié, croûte dorée et viandes confites.': 'Beans tender but intact, juices lightly bound, golden crust and confit meats.',
    'Brown saucisse': 'Brown the sausage',
    'Carotte moyenne': 'Medium carrot',
    'Oignon moyen': 'Medium onion',
    'Obtenir le ruban': 'Reach the ribbon stage',
    'Atteindre une texture souple': 'Reach a soft texture',
    'Soulève la préparation': 'Lift the mixture',
    ...
    'Poêlée de blé au poulet et curcuma': 'Wheat and chicken stir-fry with turmeric',
    'Riz sauté au poulet': 'Chicken fried rice',
    'Lentilles tomate pommes de terre sautées': 'Lentils with tomato and sautéed potatoes',
    'Effiloché d’agneau à la moutarde': 'Pulled lamb with mustard',
    'Filet de bœuf au vin rouge, pommes crousti-fondantes': 'Beef tenderloin with red wine and crisp potatoes',
    'Poulet aux tomates, poivron, vin blanc et thym': 'Chicken with tomatoes, pepper, white wine and thyme',
    'Poulet au chorizo, vin blanc et citron': 'Chicken with chorizo, white wine and lemon',
    'Poulet pommes de terre asperges': 'Chicken with potatoes and asparagus',
    'Poulet basquaise': 'Basque-style chicken',
    'Haricots tarbais au chorizo': 'Tarbais beans with chorizo',
    'Gratins de chou-fleur': 'Cauliflower gratins',
    'Saumon au four': 'Baked salmon',
    'Saucisse purée': 'Sausage and mash',
    'Rougail saucisse': 'Sausage rougail',
    'Nems vietnamiens': 'Vietnamese spring rolls',
    'Potée aux légumes': 'Country vegetable hotpot',
    'Soufflé au comté': 'Comté cheese soufflé',
    'Currys carnivores': 'Meat curries',
    'Poulet sauce pimentée': 'Chicken in spicy sauce',
    '1,2kg ailes ou pilons de poulet': '1.2kg chicken wings or drumsticks',
    'ailes ou pilons de poulet': 'chicken wings or drumsticks',
    'Coriandre fraîche': 'Fresh cilantro',
    'gingembre râpé': 'grated ginger',
    'ail râpé': 'grated garlic',
    'Poivre du moulin': 'Freshly ground pepper',
   '250g sauce chili douce': '250g sweet chili sauce',
    '35g sauce soja': '35g soy sauce',
    'Cilantro fresh': 'Fresh cilantro',
   'Plaque ou grand plat': 'Baking tray or large dish',
    'Fraises marinées et tuiles de cacao': 'Marinated strawberries and cocoa tuiles',
    'Grillades porc miel orange piment': 'Pork grills with orange, honey and chili',
    'Potato wedges citron herbes': 'Potato wedges with lemon and herbs',
   'Bistrot': 'Bistro',
    'Méditerranéen': 'Mediterranean',
    'Soir de semaine': 'Weeknight',
    'Invités': 'Guests',
    ...
    'Acras aux épinards': 'Spinach fritters',
    ...
    'Bol': 'Bowl',
    'Barbecue ou pan-broiler en fonte': 'Cast-iron barbecue or pan-broiler',
    'Couteau bien aiguisé': 'Sharp knife',
    'Pince': 'Tongs',
    'Plateau ou plat à gratin': 'Tray or baking dish',
    'Thermomètre à sonde facultatif': 'Optional probe thermometer',
  ...
  const culinaryReplacementsEn = [
    ...
    ['haricots blancs secs trempes', 'dried white beans, soaked'],
    ['haricots blancs secs trempés', 'dried white beans, soaked'],
    ['saucisse de toulouse', 'Toulouse sausage'],
    ['canard confit', 'duck confit'],
    ['haricots blancs secs', 'dried white beans'],
    ['eau froide', 'cold water'],
    ['eau neuve', 'fresh water'],
    ['cuisses', 'legs'],
    ['trempés', 'soaked'],
    ['trempes', 'soaked'],
    ['mélange', 'mix'],
    ...
    ['gras', 'fat'],
    ['mieux', 'better'],
    ['homogeneiser', 'homogenize'],
    ['homogénéiser', 'homogenize'],
    ['aer', 'aerate'],
    ['aérer', 'aerate'],
    ['donner de la tenue', 'add structure'],
    ['extraire', 'extract'],
    ['retirer l’exces', 'remove excess'],
    ['retirer l’excès', 'remove excess'],
    ['exces d’eau', 'excess water'],
    ['excès d’eau', 'excess water'],
    ['net', 'clean'],
    ['nette', 'clean'],
    ['regulier', 'even'],
    ['régulier', 'even'],
  ...
  const dynamicRules = [
    [/^(\d+) plaquette(s?)$/, match => `${match[1]} pack${match[2] ? 's' : ''}`],
    [/^(\d+) paquet(s?)$/, match => `${match[1]} pack${match[2] ? 's' : ''}`],
    [/^(\d+) bo[i\u00ee]te(s?) de 6$/, match => `${match[1]} box${match[2] ? 'es' : ''} of 6`],
    [/^(\d+) recette(s?) cochée(s?)$/, match => match[1] + ' selected recipe' + (match[1] === '1' ? '' : 's')],
    [/^(\d+) à acheter$/, match => match[1] + ' to buy'],
    [/^(\d+) déjà maison$/, match => match[1] + ' already at home'],
    [/^(\d+) coché(s?)$/, match => match[1] + ' checked'],
    [/^(\d+) article(s?)$/, match => match[1] + ' item' + (match[1] === '1' ? '' : 's')],
    [/^(\d+) article(s?) groupé(s?)$/, match => match[1] + ' grouped item' + (match[1] === '1' ? '' : 's')],
    [/^(.+) \(pour (\d+) \u00e0 (\d+) parts?\)$/, match => text(match[1]) + ' (for ' + match[2] + ' to ' + match[3] + ' slices)'],
    [/^(.+) \(pour (\d+) personnes\)$/, match => text(match[1]) + ' (for ' + match[2] + ' people)'],
    ...
    [/^(\d+) variante(s?)$/, match => `${match[1]} variant${match[1] === '1' ? '' : 's'}`],
    [/^(\d+) catégorie(s?)$/, match => `${match[1]} categor${match[1] === '1' ? 'y' : 'ies'}`],
    [/^Choix (\d+)$/, match => `Choice ${match[1]}`],
    [/^(\d+)\/(\d+) caract\u00e8res$/, match => `${match[1]}/${match[2]} characters`],
    [/^(\d+)% pr\u00eat$/, match => `${match[1]}% ready`],
    [/^(.+) · Difficulté (\d+)\/10 · Actif (.+) · Pour (.+)$/, match => `${text(match[1])} · Difficulty ${match[2]}/10 · Active ${match[3]} · For ${text(match[4])}`],
    [/^Cohérence (\d+)\/100$/, match => `Coherence ${match[1]}/100`],
    [/^Charge (.+)$/, match => `Workload ${text(match[1])}`],
    [/^(\d+) fiches$/, match => `${match[1]} recipe cards`],
    [/^(\d+) articles groupés$/, match => `${match[1]} grouped items`],
    [/^(\d+) rayons$/, match => `${match[1]} aisles`],
    [/^Actif (.+)$/, match => `Active ${match[1]}`],
    [new RegExp('^(.+) · Difficulté ([0-9]+)/10 · Actif (.+) · Pour (.+)$'), match => `${text(match[1])} · Difficulty ${match[2]}/10 · Active ${match[3]} · For ${text(match[4])}`],
    [new RegExp('^Cohérence ([0-9]+)/100$'), match => `Coherence ${match[1]}/100`],
    [new RegExp('^Charge (.+)$'), match => `Workload ${text(match[1])}`],
    [new RegExp('^([0-9]+) fiches$'), match => `${match[1]} recipe cards`],
    [new RegExp('^([0-9]+) articles groupés$'), match => `${match[1]} grouped items`],
    [new RegExp('^([0-9]+) rayons$'), match => `${match[1]} aisles`],
    [new RegExp('^(.+) : (.+)[.] Fil conducteur : (.+)[.]?$'), match => {
      const pitch = text(`${match[2].replace(/[.]$/, '')}.`);
      const throughline = text(match[3].replace(/[.]$/, ''));
      return `${text(match[1])}: ${pitch} Throughline: ${throughline}.`;
    }],
    [new RegExp('^(.+) : préparer/refroidir avant le service[.]$'), match => `${text(match[1])}: prepare/chill before serving.`],
    [new RegExp('^(.+) : lancer la cuisson principale[.]$'), match => `${text(match[1])}: start the main cooking.`],
    [new RegExp('^(.+) : préparer les bases et pesées[.]$'), match => `${text(match[1])}: prepare the bases and weigh ingredients.`],
    [new RegExp('^(.+) : profiter du temps mort pour préparer garniture, sauce ou dressage[.]$'), match => `${text(match[1])}: use the downtime to prepare the garnish, sauce or plating.`],
    [/^Cuisson (.+)$/, match => `Cooking ${match[1]}`],
    [new RegExp('^(.+) : finir et dresser juste avant d’envoyer[.]$'), match => `${text(match[1])}: finish and plate just before serving.`],
    [new RegExp('^([0-9]+)h([0-9]+) actif cumulé$'), match => `${match[1]}h${match[2]} active in total`],
    [new RegExp('^Four partagé : (.+)[.]$'), match => `Shared oven: ${match[1].split(',').map(item => text(item.trim())).join(', ')}.`],
    ...
    [/^(\d+) ingrédient(s?)$/, match => `${match[1]} ingredient${match[1] === '1' ? '' : 's'}`],
    [/^(\d+) étape(s?)$/, match => `${match[1]} step${match[1] === '1' ? '' : 's'}`],
    [/^(\d+) geste(s?)$/, match => `${match[1]} technique${match[1] === '1' ? '' : 's'}`],
    [/^(\d+)\/(\d+) étapes$/, match => `${match[1]}/${match[2]} steps`],
    ...
    [/^Changer\s+(.+?):\s*(.+)$/, match => `Change ${text(match[1])}: ${text(match[2])}`],
    ...
    [/^Retirer (.+) du panier courses$/, match => `Remove ${text(match[1])} from shopping basket`],
    [/^Marquer (.+) comme déjà à la maison$/, match => `Mark ${text(match[1])} as already at home`],
    [/^Remettre (.+) dans la liste à acheter$/, match => `Put ${text(match[1])} back on the shopping list`],
  ...
  function translateRecipeText(value) {
    ...
    const sourceTokens = normalizeI18nKey(source).split(/\s+/).filter(Boolean);
    const untranslatedContent = sourceTokens
      .filter(token => token.length >= 4 && !/^\d/.test(token) && translatedKey.includes(token));
    /* A few culinary words are also valid English (texture, preparation,
       cassoulet, proper names). Rejecting a translation because of one such
       token made short labels and technique cues fall back to French. Keep the
       conservative guard for strings where most of the source survived. */
    const untranslatedLimit = Math.max(2, Math.ceil(sourceTokens.length * 0.45));
    if (untranslatedContent.length > untranslatedLimit) return '';
