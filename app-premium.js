...
(function () {
  ...
  const INGREDIENT_GUIDE_RULES = [
      { label: 'Citron', pattern: /\b(citron|citron vert|lime|zeste|jus de citron)\b/, family: 'Agrume', season: 'Hiver-printemps, disponible toute l annee', storage: 'Avant préparation : entier au frais 2 à 3 semaines; prélever le zeste avant pressage.', pairings: 'Poisson, poulet, beurre, ail, herbes.', avoid: 'Le jus trop tôt cuit les textures fragiles et ternit les herbes.' },
      { label: 'Tomate', pattern: /\b(tomate|tomates|tomates confites|coulis tomate)\b/, family: 'Legume-fruit', season: 'Ete pour le frais; confit/coulis hors saison.', storage: 'Avant préparation : tomate entière à température ambiante; une fois coupée, la couvrir et la réfrigérer.', pairings: 'Basilic, mozzarella, ail, huile d olive, vinaigre.', avoid: 'Un passage prolongé au froid atténue le parfum de la tomate entière.' },
      { label: 'Oeuf', pattern: /\b(oeuf|oeufs|jaune|blanc|omelette|mimosa)\b/, family: 'Liaison/proteine', season: 'Toute saison', storage: 'Avant préparation : conserver les œufs au réfrigérateur, dans leur boîte; blancs ou jaunes séparés, couverts, 24 à 48 h.', pairings: 'Moutarde, herbes, fromage, champignon, piment doux.', avoid: 'Trop chauffer une liaison aux œufs provoque grainage ou texture caoutchouteuse.' },
      { label: 'Beurre', pattern: /\bbeurre\b/, family: 'Gras aromatique', season: 'Toute saison', storage: 'Avant préparation : au réfrigérateur, bien emballé et protégé des odeurs.', pairings: 'Ail, citron, sauge, pomme de terre, chocolat.', avoid: 'Beurre brûlé : amertume. Viser noisette puis stopper la cuisson.' },
      { label: 'Mascarpone', pattern: /\bmascarpone\b/, family: 'Cremerie', season: 'Toute saison', storage: 'Avant préparation : au réfrigérateur et bien fermé; utiliser rapidement après ouverture.', pairings: 'Cafe, citron, chocolat, tomate, herbes.', avoid: 'Le fouetter trop fort peut le détendre ou le grainer.' },
      { label: 'Pomme de terre', pattern: /\b(pomme de terre|pommes de terre|grenaille|rattes|puree)\b/, family: 'Feculent', season: 'Toute saison', storage: 'Avant cuisson : conserver les pommes de terre crues au sec, dans l’obscurité et dans un endroit aéré. Après cuisson : refroidir rapidement, couvrir et réfrigérer.', pairings: 'Ail, romarin, beurre, moutarde, fromage.', avoid: 'Trop travailler une purée la rend élastique.' },
      { label: 'Chocolat', pattern: /\b(chocolat|cacao|ganache)\b/, family: 'Dessert', season: 'Toute saison', storage: 'Avant préparation : chocolat solide au sec, idéalement entre 16 et 18 °C et loin des odeurs. Une ganache terminée suit la conservation indiquée par la recette.', pairings: 'Cafe, noisette, orange, vanille, fleur de sel.', avoid: 'De l’eau dans le chocolat fondu peut le faire masser et le rendre granuleux.' },
      { label: 'Crevette', pattern: /\b(crevette|crevettes|gambas)\b/, family: 'Mer', season: 'Toute saison selon origine', storage: 'Avant préparation : conserver entre 0 et 4 °C et respecter la date indiquée. Une fois cuites : couvrir, réfrigérer rapidement et consommer sous 24 h.', pairings: 'Ail, citron, chorizo, persil, piment.', avoid: 'La surcuisson rend la chair sèche et caoutchouteuse.' },
      { label: 'Carotte', pattern: /\b(carotte|carottes)\b/, family: 'Legume racine', season: 'Automne-printemps', storage: 'Avant préparation : au bac à légumes, sans fanes; couvrir et réfrigérer une carotte déjà taillée.', pairings: 'Cumin, orange, miel, noisette, fromage frais.', avoid: 'Une coupe irrégulière entraîne une cuisson inégale.' },
      { label: 'Ail', pattern: /\bail\b/, family: 'Aromate', season: 'Toute saison', storage: 'Avant préparation : tête entière au sec, à l’air et à l’abri de la lumière. Une fois épluché ou coupé : couvrir et réfrigérer.', pairings: 'Tomate, pomme de terre, crevette, agneau, beurre.', avoid: 'L’ail brûlé développe une forte amertume.' },
      { label: 'Moutarde', pattern: /\bmoutarde\b/, family: 'Condiment', season: 'Toute saison', storage: 'Avant préparation : après ouverture, conserver le pot fermé au réfrigérateur pour préserver son piquant.', pairings: 'Oeuf, porc, pomme de terre, miel, vinaigre.', avoid: 'Une longue ébullition affaiblit le piquant et aplatit la sauce.' },
      { label: 'Chorizo', pattern: /\bchorizo\b/, family: 'Charcuterie epicee', season: 'Toute saison', storage: 'Avant préparation : suivre l’emballage; une fois tranché, emballer et réfrigérer pour éviter le dessèchement.', pairings: 'Tomate, crevette, pomme de terre, oeuf, poivron.', avoid: 'Saler trop tôt : le chorizo apporte déjà sel et gras.' }
  ];
